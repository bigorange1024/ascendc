...
> **最后刷新**：2026-07-26（**768 P2/W1 B4–B6 CPU+SIM 全绿**；下一刀 W2）
...
| **SIM tick（登记）** | B4 **80783** · B5 NTT **26651** / INTT **26672** · B6 multiply **9416** / inner **21881** |
...
**W2 device**：D13 KeyGen · D14 Encrypt · D15 Decrypt（k=3）  
...
cd ascendc-tests/ml-kem/ml-kem-768/pass-fix-f203-alg11-12-multiply-inner-k3 && bash run.sh -r cpu -v Ascend910B4
