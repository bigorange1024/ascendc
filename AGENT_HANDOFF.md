...
> **最后刷新**：2026-07-27（**512 W0–W2 全绿 + W3 D19/D20**；只推 research；下一刀 W3 剩余项）
...
| **512** | **P0+P1**；**W0+W1+W2 全绿**（B1–B6，D13–D15）；**W3 D19 KeyGen + D20 Encaps PASS** |
| **授权** | `$规格说明书$` + `【预研代码】` |
| **用语** | **缺项** / **补缺** |
...
| D19 | KeyGen device | **320247** | ek 800 / dk 1632 |
...
| 项 | 说明 |
|----|------|
| **T512 W3** | 剩余 D21/D21ct KEM device（D19 KeyGen + D20 Encaps 已绿；ek/dk 800/1632；c 768；CT reject） |
