...
> **最后刷新**：2026-07-26（**768 P2/W2 全绿 + W3/D19 KEM KeyGen + D20 Encaps + D21 Decaps CPU+SIM 绿**；下一刀 D21ct）
...
| **768 P2/W3** | **D19 KEM KeyGen + D20 Encaps + D21 Decaps 有条件完成**（CPU + `SIM_DIRECT=1` sim；D19 tick **510775**，D20 tick **592129**，D21 tick **818285** = D**220767**+E**597518**；各输出 max=0；根无 stray dump）；D21ct 待做 |
...
**W3 device 下一项**：D21ct（k=3，按 §3.3 在 D21 delivery 基线之上做 CT / reject 专题；不要回改 D21 默认 `decaps_1session`）。
