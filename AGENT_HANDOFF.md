...
> **最后刷新**：2026-07-27（**512 W0 全绿** B1/B2/B3a/B3b；下一刀 W1）
...
| **512** | **P0+P1 完成**；**W0 全绿**（B1/B2/B3a/B3b） |
| **授权** | `$规格说明书$` + `【预研代码】`（继续有效） |
| **用语** | **缺项** / **补缺**；禁「洞 / 补洞」 |
...
| 项 | 说明 |
|----|------|
| **T512 W1** | B4 SampleNTT 2×2 · B5 stage123 polyvec4 · B6 Multiply/Inner |
...
cd ascendc-tests/ml-kem/ml-kem-512/pass-fix-f203-alg8-cbd-eta3-k2 && bash run.sh -r cpu -v Ascend910B4
```
