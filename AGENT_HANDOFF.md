...
> **最后刷新**：2026-07-26（**768 P2/W2 全绿 + W3/D19 KEM KeyGen + D20 Encaps CPU+SIM 绿**；下一刀 D21 Decaps device）
...
| **768 P2/W3** | **D19 KEM KeyGen + D20 Encaps 有条件完成**（CPU + `SIM_DIRECT=1` sim；D19 tick **510775**，D20 tick **592129**；`ek_kem`/`dk_kem`、`c`/`K` max=0；根无 stray dump）；D21/D21ct 待做 |
...
| **W3 探针** | [`alg19-kem-keygen-device-k3`](ascendc-tests/ml-kem/ml-kem-768/pass-fix-f203-alg19-kem-keygen-device-k3/) **CPU/SIM PASS** · [`alg20-kem-encaps-device-k3`](ascendc-tests/ml-kem/ml-kem-768/pass-fix-f203-alg20-kem-encaps-device-k3/) **CPU/SIM PASS**；D21/D21ct 仍为目录壳 |
| **SIM tick（登记）** | B4 **80783** · B5 NTT **26651** / INTT **26672** · B6 multiply **9416** / inner **21881** · D13 KeyGen **373426** · D14 Encrypt **507605** · D15 Decrypt **222032** · D19 KEM KeyGen **510775** · D20 Encaps **592129** |
...
**W3 device 下一项**：D21 Decaps（k=3，按 §3.3 接 D15 k3 Decrypt + FO）；之后 D21ct。
