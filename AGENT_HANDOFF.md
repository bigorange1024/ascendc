...
> **最后刷新**：2026-07-27（**512 W0+W1 全绿；W2 D13+D15 PASS**；只推 research，不合 main）
...
| **512** | **P0+P1 完成**；**W0+W1 全绿**（B1–B6）；**W2 D13 PASS**（tick **230102**，ek/dk **800/768B**）+ **D15 PASS**（tick **168975**） |
| **授权** | `$规格说明书$` + `【预研代码】` |
| **用语** | **缺项** / **补缺** |
...
| 项 | 说明 |
|----|------|
| **T512 W2** | D13 PKE KeyGen + D15 PKE Decrypt 已绿；D14 待补/并行接力（k=2 I/O D13 ek/dk、D14 c、D15 dk+c→m） |
