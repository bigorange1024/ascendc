...
> **最后刷新**：2026-07-26（**768 探针 W0–W3 全绿**；用户休息前**一并授权 W4**；进行中）
...
| **incubating-768** | **W4 进行中**（用户 2026-07-26 一并授权：先 customspec，再写码） |
...
| 优先级 | 项 | 说明 |
|--------|-----|------|
| **P0** | **W4a** E13–E15 | incubating PKE：customspec → 从 D13–D15 晋级写码 → CPU+SIM |
...
顺序：**E13→E14→E15→E19→E20→E21→E21ct**（每目录：`*-customspec.*` + PDF → 写码 → CPU+SIM）。  
