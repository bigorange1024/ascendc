...
> **最后刷新**：2026-07-26（**768 P2/W2 D13 KeyGen + D14 Encrypt CPU+SIM 全绿**；下一刀 D15）
...
| **768 P2/W2** | **D13 KeyGen + D14 Encrypt 有条件完成**（CPU + `SIM_DIRECT=1` sim；D13 tick **373426**，D14 tick **507605**；根无 stray）；D15 待做 |
...
| **W2 探针** | [`alg13-device-keygen-k3`](ascendc-tests/ml-kem/ml-kem-768/pass-fix-f203-alg13-device-keygen-k3/) **CPU/SIM PASS** · [`alg14-pke-encrypt-device-k3`](ascendc-tests/ml-kem/ml-kem-768/pass-fix-f203-alg14-pke-encrypt-device-k3/) **CPU/SIM PASS** |
| **SIM tick（登记）** | B4 **80783** · B5 NTT **26651** / INTT **26672** · B6 multiply **9416** / inner **21881** · D13 KeyGen **373426** · D14 Encrypt **507605** |
