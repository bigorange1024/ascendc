...
> **最后刷新**：2026-09-10（D09 msopprof 真实 cycle 已登；Timeline dump 失败；用户已断板；keepalive 已停）  
...
4. 板：`cannlab-npu`（100.107.100.36），物理 NPU7→`ASCEND_DEVICE_ID=0`；用户已断板；keepalive 已停。
