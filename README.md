...
│   └── ml-kem/
│       ├── ml-kem-512/       # ML-KEM-512 活跃探针（W0 + W1 B4/B5 已绿）
...
| **ML-KEM-512（k=2）** | **P0/P1 已定稿，W0 全绿，W1 B4/B5 已绿**：B2 [`pass-fix-f203-byteencode-decode-d-k2`](ascendc-tests/ml-kem/ml-kem-512/pass-fix-f203-byteencode-decode-d-k2/) CPU/SIM ✓（enc4 **5407** / dec4 **9340** / enc10 **6629** / dec10 **6561** / enc12 **17613**）；B3a/B3b SIM **11377** / **13566**；B4 [`pass-fix-f203-alg7-sample-ntt-k2`](ascendc-tests/ml-kem/ml-kem-512/pass-fix-f203-alg7-sample-ntt-k2/) SIM **80235** + 2×2 matrix CPU ✓；B5 [`pass-fix-f203-stage123-ntt-intt-polyvec4-k2`](ascendc-tests/ml-kem/ml-kem-512/pass-fix-f203-stage123-ntt-intt-polyvec4-k2/) NTT **22921** / INTT **22836**；禁 stable-512；下一步 W1 B6 |
