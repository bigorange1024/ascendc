...
| KEM 三分项 | **Alg.19 KeyGen device** [`pass-fix-…-device-k4`](ascendc-tests/pass-fix-f203-alg19-kem-keygen-device-k4/) **PASS**（~713k）；**Alg.20 Encaps device** [`fix-…-encaps-device-k4`](ascendc-tests/fix-f203-alg20-kem-encaps-device-k4/) **PASS**（tick **721010**，2026-07-15）；Decaps **device 待 T19b/c**；correctness oracle 仍 PASS；见 [`ascendc-tests/INDEX.md`](ascendc-tests/INDEX.md) · [`qa/TODO.md`](qa/TODO.md) |
