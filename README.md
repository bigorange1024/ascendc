...
| Encrypt 交付 | [`stable-mlkem-f203-pke-encrypt-k4`](examples/stable/stable-mlkem-f203-pke-encrypt-k4/) **SIM 主参考** tick **627590** · CPU 辅助 · KAT×10+1 / roundtrip×10+1 ✓；[交付口径](docs/notes/F203-Alg14-Encrypt-交付口径-CPU辅助与SIM主参考.md) |
