...
| KEM 三分项 | **Alg.19 KeyGen** / **Alg.20 Encaps** device+stable 已绿；**Alg.21 Decaps device** [`fix-…-decaps-device-k4`](ascendc-tests/fix-f203-alg21-kem-decaps-device-k4/) **全链 + E3 + T2 PASS**（单库+1-session；D**286k**+E**745k**）；下一 `pass-fix` 更名 / `#交付#`；见 [`ascendc-tests/INDEX.md`](ascendc-tests/INDEX.md) · [`qa/TODO.md`](qa/TODO.md) |
