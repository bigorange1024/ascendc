...
| KEM Decaps | **定型** [`stable-fips203-mlkem-kem-decaps-k4`](examples/stable/stable-fips203-mlkem-kem-decaps-k4/)（2026-07-20 `#交付#`；SIM **1032762**）；预研副本 [`exp-…`](examples/incubating/exp-fips203-mlkem-kem-decaps-k4/)；行为基线 [`pass-probe-…-decaps-device-k4`](ascendc-tests/pass-probe-f203-alg21-kem-decaps-device-k4/) |
