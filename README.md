...
| KEM 三分项 | **Alg.19 KeyGen** / **Alg.20 Encaps** device+stable 已绿；**Alg.21 Decaps device** [`fix-…-decaps-device-k4`](ascendc-tests/fix-f203-alg21-kem-decaps-device-k4/) **全链 + E3 PASS**（SIM 双库+2-session；D**283k**+E**745k**）；下一 **T2** 单库/单 session（Cloud）；见 [`ascendc-tests/INDEX.md`](ascendc-tests/INDEX.md) · [`qa/TODO.md`](qa/TODO.md) |
