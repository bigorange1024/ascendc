...
| KEM 三分项 | **Alg.19 KeyGen** / **Alg.20 Encaps** device+stable 已绿；**Alg.21 Decaps** [`pass-fix-…-decaps-device-k4`](ascendc-tests/pass-fix-f203-alg21-kem-decaps-device-k4/) **PASS**（单库+1-session；D**286k**+E**745k**）；下一 `#交付#` → stable；见 [`ascendc-tests/INDEX.md`](ascendc-tests/INDEX.md) · [`qa/TODO.md`](qa/TODO.md) |
