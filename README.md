...
| **ML-KEM-512（k=2）** | **P0/P1 已定稿，W0 B3a/B3b 已绿**：[`pass-fix-f203-alg8-cbd-eta2-k2`](ascendc-tests/ml-kem/ml-kem-512/pass-fix-f203-alg8-cbd-eta2-k2/) CPU/SIM ✓（SIM **11377**）；[`pass-fix-f203-alg8-cbd-eta3-k2`](ascendc-tests/ml-kem/ml-kem-512/pass-fix-f203-alg8-cbd-eta3-k2/) CPU/SIM ✓（SIM **13566**）；禁 stable-512；下一步 W0 剩余 B1/B2 |
