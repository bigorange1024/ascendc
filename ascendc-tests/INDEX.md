...
│   └── ml-kem-768/             # ML-KEM-768（k=3）；W0+W1+W2+D19 已绿
│       └── INDEX.md
...
| [ml-kem/ml-kem-768/](ml-kem/ml-kem-768/INDEX.md) | **W0+W1 积木绿；W2/D13 KeyGen + D14 Encrypt + D15 Decrypt 绿；W3/D19 KEM KeyGen 绿** ML-KEM-768（k=3）；D20+ KEM device 待做；见参数卡 |
