...
| [**fix-f203-alg14-encrypt-2launch-k4/**](fix-f203-alg14-encrypt-2launch-k4/) | **Alg.14 PKE Encrypt 单 session 全链（活跃）**：**CPU+SIM c.bin 1568B max=0 ✅**；SIM 病根①AIV func_key≥5→507000（核压≤5）②host 拼 matM 前缺 sync；见 [`STATUS.md`](fix-f203-alg14-encrypt-2launch-k4/STATUS.md) |
| [**fix-f203-alg14-pke-encrypt-correctness-k4/**](fix-f203-alg14-pke-encrypt-correctness-k4/) | Alg.14 PKE Encrypt 旧多 session 路线（CPU 全链 ✅；SIM c.bin 阻塞 → 已被上一行单 session 探针取代） |
