...
| [**fix-f203-alg20-kem-encaps-device-k4/**](fix-f203-alg20-kem-encaps-device-k4/) | **Alg.20 KEM Encaps（device）✅** — **T19a PASS**：prep H/G + stable Encrypt；CPU+SIM max=0；tick **721010**；liboqs KAT **CPU×10+SIM×3** |
