/**
 * @file aic_func.hpp
 * @brief Decrypt 握手骨架 toy 的 AIC MMAD：C[m,n] = A[m,k] @ B[k,n]（int8→int32）。
 *
 * 工程壳自 encrypt skel toy / pass-toy-mix 复制；本 Decrypt toy 固定调用 16×32×32。
 ...
 */
#ifndef DECRYPT_SKEL_AIC_FUNC_HPP
#define DECRYPT_SKEL_AIC_FUNC_HPP
