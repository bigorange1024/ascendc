#!/usr/bin/env bash
# vendor_sync_from_alg14_encrypt.sh — 从 alg14 Encrypt G5 复制 vendored 源到 vendor/pke_encrypt/
set -euo pipefail
...
echo "[vendor_sync] OK vendor/pke_encrypt + scripts/host_golden from alg14"
