# STATUS — fix-f203-alg21-kem-decaps-correctness-k4
...
cd ../fix-f203-alg19-kem-keygen-correctness-k4 && bash run.sh -r cpu -v Ascend910B4
cd ../fix-f203-alg20-kem-encaps-correctness-k4 && KEM_ENCAPS_SKIP_REBUILD=1 bash run.sh -r cpu -v Ascend910B4
