#!/usr/bin/env bash
# fix-f203-alg6-bytedecode-d-vec-k4 — FIPS 203 ByteDecode_d（Decrypt u: d=10 / v: d=4）
#
# Usage:
...
echo "[SUCCESS] fix-f203-alg6-bytedecode-d-vec-k4 d=${F203_BYTE_DECODE_D} (${RUN_MODE})"
