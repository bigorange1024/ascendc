#!/bin/bash
# fix-toy-decrypt-fsm-soft-gate1：SoftSyncArrive + 一轮 GATE 4↔8 轻量 MIX 玩具
#
...
echo "[SUCCESS] fix-toy-decrypt-fsm-soft-gate1 (${RUN_MODE}) kernel exit=0 (no correctness cmp)"
