#!/bin/bash
# fix-toy-decrypt-fsm-softsync1：Decrypt SoftSyncArrive（AIV0 写 / AIV1 忙等）轻量 MIX 玩具
#
...
echo "[SUCCESS] fix-toy-decrypt-fsm-softsync1 (${RUN_MODE}) kernel exit=0 (no correctness cmp)"
