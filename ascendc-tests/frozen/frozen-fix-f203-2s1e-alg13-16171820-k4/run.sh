#!/bin/bash
# fix-f203-2s1e-alg13-16171820-k4
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} NTTS2S1E_MIX_PASS=${NTTS2S1E_MIX_PASS} F203_STAGE1_SPLIT=${F203_STAGE1_SPLIT}"
...
echo "[SUCCESS] fix-f203-2s1e-alg13-16171820-k4 (${RUN_MODE})"
