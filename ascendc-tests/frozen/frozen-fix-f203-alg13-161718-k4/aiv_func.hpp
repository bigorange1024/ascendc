...
/**
 * Stage1（待迁 poly-batch）：当前为 limbsplit-s123 系数半维切分 + S0 [HI_k|LO_k]。
 * 目标：AivSplitPolyBatch（fix-f203-tag5t-ntt256-limb6-poly8-polybatch-s123）；见 docs/notes/MLKEM-NTT-实现总结.md、qa/TODO T11。
 */
class AivSplit {
public:
