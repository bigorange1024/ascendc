...
- **例外（KEM vendor 快照）**：[`fix-f203-alg21-kem-decaps-k4`](../../fix-f203-alg21-kem-decaps-k4/) 的 `vendor_sync_from_alg15_decrypt.sh` **允许** rsync 本树到 `vendor/pke_decrypt/`（2-launch G4；stable Decrypt 为 1-kernel）。这是拼装快照，不是活跃交付路径。
