...
历史：roundtrip CPU+SIM max=0（2026-06-30）；liboqs Decrypt m max=0（2026-07-01）。详 [`docs/notes/F203-PKE-liboqs交叉验证与Compress定点技术总结.md`](../../docs/notes/F203-PKE-liboqs交叉验证与Compress定点技术总结.md)。
