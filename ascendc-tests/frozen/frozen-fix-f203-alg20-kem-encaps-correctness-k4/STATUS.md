# STATUS — fix-f203-alg20-kem-encaps-correctness-k4
...
| **参数集** | ml_kem_1024（k=4） |
| **公钥 input** | **`ek_kem.bin` 1568B** ← [`fix-f203-alg19-kem-keygen-correctness-k4`](../fix-f203-alg19-kem-keygen-correctness-k4/) `output/`（同 `SEED_D`；**不**内嵌 KeyGen） |
...
| 段 | 来源 | 状态 |
|----|------|------|
| Alg.19 KeyGen | [`fix-f203-alg19-kem-keygen-correctness-k4`](../fix-f203-alg19-kem-keygen-correctness-k4/) | **PASS**（供给 `ek_kem`） |
