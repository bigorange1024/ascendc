# INTEGRATION_PLAN — fix-f203-alg21-kem-decaps-correctness-k4
...
| `DK_KEM_SRC` | `../fix-f203-alg19-kem-keygen-correctness-k4/output/dk_kem.bin` |
| `C_SRC` | `../fix-f203-alg20-kem-encaps-correctness-k4/output/c.bin` |
...
# Decaps
cd ../fix-f203-alg21-kem-decaps-correctness-k4
...
| alg20 Encaps | [`../fix-f203-alg20-kem-encaps-correctness-k4/INTEGRATION_PLAN.md`](../fix-f203-alg20-kem-encaps-correctness-k4/INTEGRATION_PLAN.md) |
