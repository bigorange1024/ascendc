...
export DK_KEM_SRC="${DK_KEM_SRC:-${CURRENT_DIR}/../frozen-fix-f203-alg19-kem-keygen-correctness-k4/output/dk_kem.bin}"
export C_SRC="${C_SRC:-${CURRENT_DIR}/../frozen-fix-f203-alg20-kem-encaps-correctness-k4/output/c.bin}"
export K_ENC_SRC="${K_ENC_SRC:-${CURRENT_DIR}/../frozen-fix-f203-alg20-kem-encaps-correctness-k4/output/K.bin}"
...
msprof_run_kernel ./ascendc_kem_decaps_bbit
