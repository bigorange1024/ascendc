...
/** merged_kyber AicMmad + F203 mat_c [16,512] 列拼接写回 */
class AicMmad {
public:
...
private:
    ...
    __aicore__ inline void CopyIn()
    {
        ...
        nd2nzA1Params.srcNdMatrixStride = 1;
        nd2nzA1Params.srcDValue = k;
        nd2nzA1Params.dstNzC0Stride = 16;
        nd2nzA1Params.dstNzNStride = 1;
        nd2nzA1Params.dstNzMatrixStride = 1;
        ...
        nd2nzB1Params.srcNdMatrixStride = 1;
        nd2nzB1Params.srcDValue = n;
        nd2nzB1Params.dstNzC0Stride = ceil_div(k, 16) * 16;
        nd2nzB1Params.dstNzNStride = 1;
        nd2nzB1Params.dstNzMatrixStride = 1;
    ...
    __aicore__ inline void SplitB()
    {
        ...
        uint32_t dstOffset = ceil_div(n, 32) * CUBE_BLOCK_SIZE;
        uint32_t srcOffset = CUBE_BLOCK_SIZE;
