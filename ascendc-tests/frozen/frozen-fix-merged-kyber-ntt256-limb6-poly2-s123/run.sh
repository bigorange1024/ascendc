#!/bin/bash
# Phase D′ poly2 s123：batch Split + 2×Mmad + batch Merge
# Usage:
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} SIM_DIRECT=${SIM_DIRECT} (fix poly2 s123: Split+Mmad+Merge)"
...
echo "[SUCCESS] fix-merged-kyber-ntt256-limb6-poly2-s123 (${RUN_MODE})"
