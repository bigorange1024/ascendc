/**
 * Stage2 Matmul：与 int8-matmul-cube-16x256x512/int8_matmul_custom.cpp 同构。
 * SIM 须单 kernel 包（S12_KERNEL_MODE=stage2），勿与 mmad 混编。
 */
...
extern "C" __global__ __aicore__ void stage2_matmul_custom(GM_ADDR matAGm, GM_ADDR lutGm, GM_ADDR matCGm,
