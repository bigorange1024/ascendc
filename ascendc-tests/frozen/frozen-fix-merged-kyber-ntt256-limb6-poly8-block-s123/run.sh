#!/bin/bash
# poly8 block s123：S0 行序 [HI_8|LO_8]；LUT 不变；dst 应与 poly8-s123 一致
# Usage:
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} SIM_DIRECT=${SIM_DIRECT} (poly8 block s123: S0=[HI|LO])"
...
echo "[SUCCESS] fix-merged-kyber-ntt256-limb6-poly8-block-s123 (${RUN_MODE})"
