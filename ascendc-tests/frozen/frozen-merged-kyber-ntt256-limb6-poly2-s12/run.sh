#!/bin/bash
# Phase D′ poly2：Stage1 Split + Stage2 Mmad（无 Merge）
# Usage:
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} SIM_DIRECT=${SIM_DIRECT} (Phase D′ limb6 poly2 s12)"
...
echo "[SUCCESS] merged-kyber-ntt256-limb6-poly2-s12 (${RUN_MODE})"
