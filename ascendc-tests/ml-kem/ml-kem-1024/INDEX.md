# ascendc-tests/ml-kem/ml-kem-1024 — ML-KEM-1024（k=4）活跃探针

**参数组**：FIPS 203 **ML-KEM-1024**（k=4）。  
**上级**：[../INDEX.md](../INDEX.md) · [../../INDEX.md](../../INDEX.md)  
**对应 examples**：[`examples/incubating/ml-kem/ml-kem-1024/`](../../../examples/incubating/ml-kem/ml-kem-1024/) · [`examples/stable/ml-kem/ml-kem-1024/`](../../../examples/stable/ml-kem/ml-kem-1024/)  
**frozen 不在此树**（见 [`../../frozen/INDEX.md`](../../frozen/INDEX.md)）。

| 规则 | 说明 |
|------|------|
| **目录名** | `<简述>/`，不加 `exp-` 前缀 |
| **`pass-` 前缀** | CPU + SIM 均已验收的**终态**探针加 `pass-`；进行中保持 `fix-` |
| **状态** | 各目录 `STATUS.md`：`CPU` / `SIM` 列 |
| **自包含** | 见 [用例自包含与设备全链约束.md](../../../docs/engineering/用例自包含与设备全链约束.md) |
...
| [**pass-f203-compress-unified-int-vec-k4/**](pass-f203-compress-unified-int-vec-k4/) | **已迁至** [`exp-fips203-compress-unified-int-vec-k4`](../../../examples/incubating/ml-kem/ml-kem-1024/exp-fips203-compress-unified-int-vec-k4/)（canonical + customspec） | ✓ | 部分 |
...
| [**pass-f203-decompress-unified-int-vec-k4/**](pass-f203-decompress-unified-int-vec-k4/) | **已迁至** [`exp-fips203-decompress-unified-int-vec-k4`](../../../examples/incubating/ml-kem/ml-kem-1024/exp-fips203-decompress-unified-int-vec-k4/)（canonical + customspec） | ✓ | 部分 |
...
| [**pass-fix-f203-alg21-kem-decaps-device-ct-k4/**](pass-fix-f203-alg21-kem-decaps-device-ct-k4/) | **Alg.21 KEM Decaps（device / CT 专题）** — 同上架构；SIM 默认 **`decaps_2session`**；仅 `research/formal-lang-dag`；对应 [`stable-…-decaps-ct-k4`](../../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-kem-decaps-ct-k4/) | ✓ | ✓ |

Phase A 早期 harness 已归档：[`frozen/frozen-f203-ntt-phase-a-fsm/`](../../frozen/frozen-f203-ntt-phase-a-fsm/)（2026-06-19，任务完成非路线否决）。

**MLKEM NTT + 向量集成**：向量全链路 **[vec-k4-v2](pass-fix-f203-2s1e-alg13-16171820-vec-k4-v2/)**；**8-poly 批 NTT/INTT** **[pass-fix-f203-stage123-ntt-intt-polyvec8-vec](pass-fix-f203-stage123-ntt-intt-polyvec8-vec/)**；标量对照组 [`frozen-fix-f203-2s1e-alg13-16171820-k4`](../../frozen/frozen-fix-f203-2s1e-alg13-16171820-k4/)（2026-06-19 归档，任务完成）。预研 [`exp-k4`](../../../examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-pke-alg13-16171820-2s1e-k4/)。见 [MLKEM-NTT-向量与标量实现指南.md](../../../docs/notes/MLKEM-NTT-向量与标量实现指南.md)。
...
| ~~fix-f203-alg14-pke-encrypt-correctness-k4~~ | **已冻结**（2026-07-10）→ [`frozen/frozen-fix-f203-alg14-pke-encrypt-correctness-k4/`](../../frozen/frozen-fix-f203-alg14-pke-encrypt-correctness-k4/)；交付 [`stable-fips203-mlkem-pke-encrypt-k4`](../../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4/) |
| ~~fix-f203-alg15-pke-decrypt-correctness-k4~~ | **已冻结**（2026-07-10）→ [`frozen/frozen-fix-f203-alg15-pke-decrypt-correctness-k4/`](../../frozen/frozen-fix-f203-alg15-pke-decrypt-correctness-k4/)；交付 [`stable-fips203-mlkem-pke-decrypt-k4`](../../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-decrypt-k4/) |
