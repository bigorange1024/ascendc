...
```bash
# 单用例
cd ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg11-12-innerproduct-k4-halfrows && bash run.sh -r sim -v Ascend910B4
cd ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-2s1e-byteencode12-vec-k4 && bash run.sh -r sim -v Ascend910B4
...
*与 [STATUS.md](STATUS.md)、[qa/2026-06-19 纪要](../../qa/2026-06/2026-06-19-ByteEncode12-only探针与prefetch实验.md) §8–§9、[exp-k4 STATUS](../../examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-pke-alg13-16171820-2s1e-k4/STATUS.md) 同步。*
