#!/bin/bash
# pass-fix-f203-alg11-12-innerproduct-k4 — 4×4×1 polyvec 内积（KeyGen K=4；GM a_hat/s_hat 与 alg13 一致）
#
# Usage:
...
echo "[SUCCESS] pass-fix-f203-alg11-12-innerproduct-k4 (${RUN_MODE})"
