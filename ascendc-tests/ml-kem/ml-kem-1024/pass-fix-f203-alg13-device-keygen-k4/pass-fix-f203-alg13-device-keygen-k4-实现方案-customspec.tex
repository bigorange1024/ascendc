...
\begin{abstract}
本文档描述 \textbf{验收探针} \dirname{ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg13-device-keygen-k4/}：
...
交付示例对照：\dirname{examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-pke-keygen-k4/}（用户 I/O 契约相同，本探针为验证基线）。
...
Total tick \textbf{542339}（task0 prep $\approx$462k + task1 mmad $\approx$81k）。
