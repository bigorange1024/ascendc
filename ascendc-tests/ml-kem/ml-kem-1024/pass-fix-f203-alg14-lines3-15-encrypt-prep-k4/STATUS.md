...
**代码来源**：vendoring **仅** [`stable-fips203-mlkem-pke-keygen-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4/) `prep/`；**禁止**抄 [`stable-fips203-mlkem-pke-encrypt-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4/)。
...
```bash
cd ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg14-lines3-15-encrypt-prep-k4
