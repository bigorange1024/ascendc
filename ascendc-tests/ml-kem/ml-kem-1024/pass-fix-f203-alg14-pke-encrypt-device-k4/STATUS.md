...
**种子（已锁定）**：全链唯一种子 **`SEED_D=20260619`**；输入与 golden 复制自 [`stable-fips203-mlkem-pke-encrypt-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4/)。单段探针各自种子（prep `20260706`、compute+tail `20260708`）**不**用于本全链。
...
- **锁死种子** `SEED_D=20260619`，输入与 golden **直接复用** [`stable-fips203-mlkem-pke-encrypt-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4/)（该套已 device 验证 max=0）。
...
- 从 [`stable-fips203-mlkem-pke-encrypt-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4/) 抄码（旧 G5 拼装路线）
