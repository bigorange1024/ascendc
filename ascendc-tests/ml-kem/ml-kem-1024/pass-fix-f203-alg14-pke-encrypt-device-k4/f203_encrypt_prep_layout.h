 ...
 *
 * 流水线位置：
 *   - 行 3–7：ek_pke 尾 ρ[32] → SampleNTT → a_hat[k²,256] int32
 *   - 行 8–15：coins[32] → PRF(η=2) → CBD → re[2k+1,256] int32（r‖e₁‖e₂）
 *
 * 与 golden I/O：
 ...
 *
 * 编译开关：F203_AHAT16_BLOCK_DIM（默认 2）控制双 AIV 分片 Â；见 f203_a_hat16_config.h。
 */
#pragma once
...
/** a_hat 扁平字节数：16×256×sizeof(int32)。 */
