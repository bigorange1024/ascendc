...
自 `fix-f203-alg15-pke-decrypt-device-k4` 改名（2026-07-09）：CPU+SIM + roundtrip 已验收；**已晋级** [`stable-fips203-mlkem-pke-decrypt-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-decrypt-k4/)（2026-07-10，T15a）。
...
回退 2-launch：`DECRYPT_DIR=.../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-decrypt-k4`。

## 下一步

- 晋级 `examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-decrypt-k4`（**T15a 已完成**，2026-07-10）
