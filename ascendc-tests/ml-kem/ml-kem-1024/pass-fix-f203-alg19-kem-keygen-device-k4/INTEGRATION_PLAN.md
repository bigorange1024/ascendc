...
| [`stable-fips203-mlkem-pke-keygen-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4/) | **Alg.13 PKE KeyGen** 权威实现（2 launch，SIM ~542k tick） |
...
```cmake
set(STABLE_KEYGEN_ROOT "${REPO_ROOT}/examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4")
...
基于 stable [`main_keygen.cpp`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4/main_keygen.cpp) 最小 diff：
...
```bash
cd ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg19-kem-keygen-device-k4

# G1：临时 F203_KEM_KEYGEN_TAIL=0 构建后，ek_pke/dk_pke vs stable
cd ../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4 && bash run.sh -r cpu -v Ascend910B4
