...
|----|-------------|---------------|
| PKE 源码 | `vendor/pke_keygen` rsync | **编译期引用** [`stable-fips203-mlkem-pke-keygen-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4/)（见 [`INTEGRATION_PLAN.md`](INTEGRATION_PLAN.md) §4） |
