...
#
# PKE 源码：编译期引用 examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4（无 vendor/）
#
...
STABLE_KEYGEN="${REPO_ROOT}/examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-keygen-k4"
