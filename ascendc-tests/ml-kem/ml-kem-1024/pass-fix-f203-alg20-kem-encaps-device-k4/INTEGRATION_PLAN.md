...
| 路径 | 角色 |
|------|------|
| [`stable-fips203-mlkem-pke-encrypt-k4`](../../examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4/) | **Alg.14 Encrypt** 权威（SIM 2 launch） |
...
```bash
cd ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg20-kem-encaps-device-k4
