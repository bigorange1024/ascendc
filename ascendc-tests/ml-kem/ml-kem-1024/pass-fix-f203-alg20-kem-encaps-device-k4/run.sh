...
# PKE：编译期引用 examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-encrypt-k4
#
# Usage（默认全量）:
...
echo "[kem_encaps device-k4] RUN_MODE=${RUN_MODE} profile=${BUILD_PROFILE} BUDGET_SEC=${KERNEL_COMPUTE_BUDGET_SEC} ASCEND_DEVICE_ID=${ASCEND_DEVICE_ID:-n/a}"
