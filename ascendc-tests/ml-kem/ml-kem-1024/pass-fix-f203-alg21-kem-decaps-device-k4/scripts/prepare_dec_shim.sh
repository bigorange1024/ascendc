...
#
# 源：examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-decrypt-k4（编译期权威；禁止 frozen）
...
SRC="${REPO_ROOT}/examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-pke-decrypt-k4"
