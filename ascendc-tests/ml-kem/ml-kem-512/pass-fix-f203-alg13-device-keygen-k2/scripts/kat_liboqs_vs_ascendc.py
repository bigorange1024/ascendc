...
"""liboqs PKE KeyGen ↔ 探针 AscendC 对拍（pass-fix-f203-alg13-device-keygen-k2）。

种子契约（与 run.sh / 设备 DerandFromSeedD 一致）：
  SEED_D → d = SHA3-256("exp-mlkem-f203-2s1e-k2:SEED_D=<decimal>")
  liboqs：ml_kem_512 indcpa coins[0:32]
