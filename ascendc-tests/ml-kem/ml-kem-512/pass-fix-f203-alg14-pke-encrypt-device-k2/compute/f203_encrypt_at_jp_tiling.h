...
constexpr int32_t kK = 2;             /**< Â / r̂ 维数 */
constexpr int32_t kPPerAiv = 2;       /**< 每 AIV 最大驻留行数：AIV0=u0/u1，AIV1=tr̂/空槽 */
...
/** outLine: û 输出 [kPPerAiv,kN]；trLine: k2 的 tr̂ 行（最终放入 AIV1 第 1 个 INTT slot） */
