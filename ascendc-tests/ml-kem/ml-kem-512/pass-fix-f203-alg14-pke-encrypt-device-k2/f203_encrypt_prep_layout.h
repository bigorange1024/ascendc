 ...
 * @brief Alg.14 Encrypt prep 单内核 I/O 尺寸（ML-KEM-512，行 3–15：Â + r/e₁/e₂）。
 *
 * 流水线位置：
 ...
 *
 * 编译开关：F203_AHAT16_BLOCK_DIM（默认 2）控制双 AIV 2+2 分片 Â；见 f203_a_hat16_config.h。
 */
#pragma once
