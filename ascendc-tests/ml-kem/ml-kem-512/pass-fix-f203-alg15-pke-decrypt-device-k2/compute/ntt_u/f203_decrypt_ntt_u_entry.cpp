 ...
 * @brief G2：u' polyvec k=2 三段式 NTT（MIX 1×AIC + 2×AIV，mixPass=3）。
 *
 * 语义：k2 poly-batch Stage123，AIV0=poly0、AIV1=poly1，NTT S1–S3 禁 Gather。
 * 输入 src [2,256] int32（time 域 u'）；输出 dst [2,256] int32（NTT 域 û）。
