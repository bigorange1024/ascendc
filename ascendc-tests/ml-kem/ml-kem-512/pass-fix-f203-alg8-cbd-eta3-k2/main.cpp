...
namespace {
constexpr size_t kPrfBytes = F203CbdEta3Host::PRF_TOTAL_BYTES;  // 4*192=768
constexpr size_t kSrcBytes = static_cast<size_t>(F203CbdEta3Host::SRC_COEFFS) * sizeof(int32_t);  // 4*256*4=4096
}  // namespace
...
int32_t main(int32_t argc, char *argv[])
{
    ...
    std::cout << "[main] Alg.8 CBD eta=3 k=2 rows=" << F203CbdEta3Host::ROWS << " prf_bytes=" << kPrfBytes
    ...
    ICPU_RUN_KF(f203_cbd_eta3_batch4, kCpuLaunchBlockDim, prf_gm, reinterpret_cast<uint8_t *>(src_gm));
    ...
    f203_cbd_eta3_batch4_do(kHostBlockDim, nullptr, stream, prf_dev, reinterpret_cast<uint8_t *>(src_dev));
