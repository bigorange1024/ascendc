#!/bin/bash
# pass-fix-f203-alg8-cbd-eta3-k2 — FIPS 203 Alg.8 SamplePolyCBD η=3（4×poly，k=2，ML-KEM-512）
#
# 默认路径：P2 双 AIV + DataCopy + load24/SWAR+LUT（blockDim=2），无需配置编译开关。
# T-B2 polyvec4：ROWS=4，AIV0={0,2} / AIV1={1,3}；核符号 f203_cbd_eta3_batch4。
#
# Usage（验收默认）：
...
echo "[SUCCESS] pass-fix-f203-alg8-cbd-eta3-k2 (${RUN_MODE}) block_dim=${_CBD_BLOCK_DIM}"
