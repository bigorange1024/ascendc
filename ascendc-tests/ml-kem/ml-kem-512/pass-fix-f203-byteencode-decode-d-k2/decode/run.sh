#!/usr/bin/env bash
# pass-fix-f203-mlkem512-sub-bytedecode-d-k2 — FIPS 203 ByteDecode_d（本树验收 d=4/10）
#
...
echo "[SUCCESS] pass-fix-f203-byteencode-decode-d-k2/decode d=${F203_BYTE_DECODE_D} (${RUN_MODE})"
