#!/usr/bin/env bash
# pass-fix-f203-mlkem512-sub-byteencode-d-k2 — FIPS 203 ByteEncode_d（本树验收 d=4/10）
#
...
echo "[SUCCESS] pass-fix-f203-byteencode-decode-d-k2/encode d=${F203_BYTE_ENCODE_D} (${RUN_MODE})"
