# STATUS — encode12/（pass-fix-f203-byteencode-decode-d-k2）

**ByteEncode₁₂-only** algorithm probe：本目录位于 ML-KEM-512/k2 W0/B2，但仍复用 1024 Tag5T v2 的 k=4、2×AIV、4×384B 几何生成输入与 golden；512 KeyGen 的真实 k=2 打包留给后续 D13/KeyGen 探针锁定。
