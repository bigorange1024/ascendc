#!/bin/bash
# pass-fix-f203-byteencode-decode-d-k2/encode12 — ByteEncode₁₂-only（512 树下的 d=12 算法探针）
#
# Usage:
...
#
# 环境变量：
#   BYTE_ENCODE12_VEC — 0 标量 / 1 向量（默认）
#   BYTE_ENCODE12_PREFETCH — 0 tile32 循环 / 1 整 poly ROM+Gather（默认）
#
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} BYTE_ENCODE12_VEC=${BYTE_ENCODE12_VEC} BYTE_ENCODE12_SCATTER_VEC=${BYTE_ENCODE12_SCATTER_VEC} BYTE_ENCODE12_PREFETCH=${BYTE_ENCODE12_PREFETCH}"
...
echo "[SUCCESS] pass-fix-f203-byteencode-decode-d-k2/encode12 (${RUN_MODE})"
