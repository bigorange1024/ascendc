#!/usr/bin/env bash
# pass-fix-f203-mlkem512-sub-decompress-d-vec-k2 — FIPS 203 Decompress_d（验收 d=4/5/10/11）
#
...
echo "[SUCCESS] pass-fix-f203-compress-decompress-du10-dv4-k2/decompress d=${F203_DECOMPRESS_D} (${RUN_MODE})"
