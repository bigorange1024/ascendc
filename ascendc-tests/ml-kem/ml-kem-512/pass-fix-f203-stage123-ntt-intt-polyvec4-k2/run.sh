#!/usr/bin/env bash
# pass-fix-f203-stage123-ntt-intt-polyvec4-vec — 4-poly 紧凑三段式 NTT/INTT（MIX）
#
# Usage:
...
#   STAGE123_POLYVEC4_MIX_PASS — 0=S1 / 1=S2 / 2=S3 / 3=全链（默认）
#
...
export STAGE123_POLYVEC4_MIX_PASS="${STAGE123_POLYVEC4_MIX_PASS:-3}"
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} F203_NTT_MODE=${F203_NTT_MODE} mixPass=${STAGE123_POLYVEC4_MIX_PASS}"
...
echo "[SUCCESS] pass-fix-f203-stage123-ntt-intt-polyvec4 mode=${F203_NTT_MODE} (${RUN_MODE})"
