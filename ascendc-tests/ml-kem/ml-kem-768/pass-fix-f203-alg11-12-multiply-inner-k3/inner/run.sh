#!/bin/bash
# pass-fix-f203-alg11-12-multiply-inner-k3/inner — 4×4×1 半行内积（双 AIV；GM a_hat/s_hat 与 alg13 一致）
#
# Usage:
...
export INNERPRODUCT_P_OUT="${INNERPRODUCT_P_OUT:-3}"
export INNERPRODUCT_S_VEC="${INNERPRODUCT_S_VEC:-3}"
...
echo "[SUCCESS] pass-fix-f203-alg11-12-multiply-inner-k3/inner (${RUN_MODE})"
