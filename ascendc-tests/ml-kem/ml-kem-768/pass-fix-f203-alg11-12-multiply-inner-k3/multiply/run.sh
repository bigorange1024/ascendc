#!/bin/bash
# pass-fix-f203-alg11-12-multiply-inner-k3/multiply — FIPS 203 Alg.11/12 (C path inside AscendC shell)
#
# Usage:
...
echo "[SUCCESS] pass-fix-f203-alg11-12-multiply-inner-k3/multiply (${RUN_MODE})"
