# 源码注释说明 — pass-fix-f203-alg13-device-keygen-k3
...
1. `pass-fix-f203-alg13-device-keygen-k3-实现方案-customspec.tex`
...
bash ../../scripts/xelatex-clean.sh pass-fix-f203-alg13-device-keygen-k3-实现方案-customspec.tex
```
