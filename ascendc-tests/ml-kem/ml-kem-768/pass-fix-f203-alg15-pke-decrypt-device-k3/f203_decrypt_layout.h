 ...
 * @brief FIPS 203 Alg.15 PKE Decrypt 尺寸常量（ml_kem_768 / k=3）。
 *
 * 生产 I/O（Host 文件 / 设备指针语义）：
 *   输入  dk_PKE = ByteEncode₁₂(ŝ)     F203_DK_PKE_BYTES = 1152
 *         c = c₁‖c₂                   F203_CT_PKE_BYTES = 1088
...
#define F203_DECRYPT_K 3
#define F203_DECRYPT_N 256
#define F203_DECRYPT_Q 3329

#define F203_DK_PKE_BYTES 1152U /* k × 384 = ByteEncode₁₂(ŝ) */
#define F203_CT_PKE_BYTES 1088U /* 960 + 128 */
