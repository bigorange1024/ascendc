#!/usr/bin/env bash
# pass-fix-f203-alg15-pke-decrypt-device-k3 — ML-KEM-768 FIPS 203 Alg.15 PKE Decrypt（fused）
#
# 生产 I/O：
#   input/  — dk_pke.bin (1152B) + c.bin (1088B) + LUT
#   output/ — m.bin (32B)
#
...
echo "[SUCCESS] pass-fix-f203-alg15-pke-decrypt-device-k3 (${RUN_MODE}) DECRYPT_VERIFY=${DECRYPT_VERIFY} COMPRESS_1_VEC=${COMPRESS_1_VEC:-1} DECOMPRESS_D_VEC=${DECOMPRESS_D_VEC:-1}"
