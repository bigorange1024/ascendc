#!/bin/bash
# pass-fix-f203-alg7-sample-ntt-k3 — FIPS 203 Alg.7 SampleNTT（单 poly 模块）
#
# 本脚本为探针 pass-fix-f203-alg7-sample-ntt-k3 的端到端验收入口：
...
echo "[SUCCESS] pass-fix-f203-alg7-sample-ntt-k3 (${RUN_MODE})"
