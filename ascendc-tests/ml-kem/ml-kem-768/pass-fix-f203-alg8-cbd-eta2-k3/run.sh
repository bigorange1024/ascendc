#!/bin/bash
# pass-fix-f203-alg8-cbd-eta2-k3 — FIPS 203 Alg.8 SamplePolyCBD η=2（6×poly，k=3，ML-KEM-768）
#
# 默认即最优路径：P2 双 AIV + DataCopy + SWAR+LUT（blockDim=2），无需配置编译开关。
# polyvec6：AIV0={0,1,3} / AIV1={2,4,5}；核符号 f203_cbd_eta2_batch6。
#
# Usage：
...
echo "[SUCCESS] pass-fix-f203-alg8-cbd-eta2-k3 (${RUN_MODE}) block_dim=${_CBD_BLOCK_DIM}"
