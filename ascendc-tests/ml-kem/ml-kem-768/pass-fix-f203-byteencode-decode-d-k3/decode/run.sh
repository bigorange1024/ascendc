#!/usr/bin/env bash
# pass-fix-f203-mlkem768-sub-alg6-bytedecode-d-vec-k4 — FIPS 203 ByteDecode_d（验收 d=4/5/10/11）
#
...
echo "[SUCCESS] pass-fix-f203-byteencode-decode-d-k3/decode d=${F203_BYTE_DECODE_D} (${RUN_MODE})"
