#!/usr/bin/env bash
# pass-fix-f203-mlkem768-sub-byteencode-d-vec-k4 — FIPS 203 ByteEncode_d（验收 d=4/5/10/11）
#
...
echo "[SUCCESS] pass-fix-f203-byteencode-decode-d-k3/encode d=${F203_BYTE_ENCODE_D} (${RUN_MODE})"
