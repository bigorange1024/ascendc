#!/usr/bin/env bash
# pass-fix-f203-byteencode-decode-d-k3 — ML-KEM-768 W0/B2
#
# 编排：
#   encode/ + decode/ — ByteEncode/Decode_d，验收 d∈{4,10}（768 密文域）
...
echo "[SUCCESS] pass-fix-f203-byteencode-decode-d-k3 d∈{${DS}}+encode12 (${_ORIG_ARGS[*]:--r cpu})"
exit 0
