#!/usr/bin/env bash
# pass-fix-f203-compress-decompress-du10-dv4-k3 — ML-KEM-768 W0/B1
#
# 编排子探针：compress/ + decompress/，锁定验收 d∈{4,10}（768 的 d_v / d_u）。
...
echo "[SUCCESS] pass-fix-f203-compress-decompress-du10-dv4-k3 d∈{${DS}} (${_ORIG_ARGS[*]:--r cpu})"
exit 0
