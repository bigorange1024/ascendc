 ...
 *
 * 流水线位置：
 *   - Stage1：AivK6Split.encodeBank → split_vec → S0 [12,256] int8；
 *   - Stage3：AivK6RouteAMod → combine_limb6_routea_mod_vec → dst [6,256] int32。
 *
 * 作用：
 ...
 *
 * 与 golden 关系：gen_data 平面 mat_c + stage31_mod 语义；dst.bin [6,256] NTT/INTT 后系数。
 *
