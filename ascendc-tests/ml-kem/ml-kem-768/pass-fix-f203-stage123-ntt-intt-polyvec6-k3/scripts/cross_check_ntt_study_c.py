...
比对：
  ...
  3. sepolyvec6_ntt_f203 交付 input0.bin / golden.bin vs C 参考
...
_DELIVER = os.path.join(_CASE_DIR, "thirdparty/ntt_onnx/deliverables/sepolyvec6_ntt_f203")
...
def deliverable_vs_c(mode: str) -> bool | None:
    ...
    if not (os.path.isfile(in0) and os.path.isfile(gold)):
        ...
        return None
    print("[cross_check] sepolyvec6_ntt_f203 deliverable golden vs ntt_study C")
