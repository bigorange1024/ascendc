...
（打包比特流）不便直接随机构造出合法值，故先随机生成压缩系数 comp，再借用上游
pass-f203-byteencode-d-vec-k4 目录的 byte_encode_d_ref.c 把它编码为 encoded，
...
# 上游 ByteEncode_d 探针目录：本脚本复用其 byte_encode_d_ref.c 生成合法的 encoded 输入。
_ENCODE_DIR = os.path.normpath(os.path.join(_CASE_DIR, "..", "pass-f203-byteencode-d-vec-k4"))
