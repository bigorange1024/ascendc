#!/usr/bin/env bash
# pass-f203-compress-d4-d10-vec-k4 — FIPS 203 Compress_d（验收 d=4 / d=10）
#
# Usage:
#   bash run.sh -r cpu -v Ascend910B4
#   F203_COMPRESS_D=10 bash run.sh -r sim -v Ascend910B4
#
# 环境变量：
#   F203_COMPRESS_D — 4（默认，Encrypt v）或 10（Encrypt u）
#   COMPRESS_D_VEC  — 0 标量 / 1 向量（d=4 默认向量；d=10 设备暂标量）
...
echo "[SUCCESS] pass-f203-compress-d4-d10-vec-k4 d=${F203_COMPRESS_D} (${RUN_MODE})"
