#!/usr/bin/env bash
# pass-f203-decompress-unified-int-vec-k4 — 统一整数舍入 Decompress_d（d=1/4/5/10/11）
#
...
echo "[SUCCESS] pass-f203-decompress-unified-int-vec-k4 d=${F203_UNIFIED_ROUND_D} (${RUN_MODE})"
