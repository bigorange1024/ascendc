#!/bin/bash
# pass-fix-f203-alg14-lines3-15-encrypt-prep-k4 — Alg.14 prep：Â + r/e₁/e₂（单 launch，stable vendored）
#
# Usage（默认）：
...
echo "[SUCCESS] pass-fix-f203-alg14-lines3-15-encrypt-prep-k4 (${RUN_MODE})"
