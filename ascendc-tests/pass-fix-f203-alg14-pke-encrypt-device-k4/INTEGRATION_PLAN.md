...
| KEM Encaps 并入 | 由 [`pass-fix-…-encaps-device-k4`](../pass-fix-f203-alg20-kem-encaps-device-k4/) / [`stable-…-kem-encaps-k4`](../../examples/stable/stable-fips203-mlkem-kem-encaps-k4/) 负责（correctness 已冻结） |
