#!/bin/bash
# =============================================================================
# pass-shake256-ascendc-toy — 共享 shake_xof_kernel + rate=136（SHAKE256）AscendC 对拍
# =============================================================================
#
# Usage：
...
#
# 环境变量：
#   SHAKE256_CASE — abc（默认）| empty | prf_sigma_n0 | rate_135 | rate_136 | rate_137 | batch_mixed
#   SEED_D        — prf_sigma_n0 用例 derand 种子（默认 20260619）
# =============================================================================
CURRENT_DIR=$(
...
export SHAKE256_CASE="${SHAKE256_CASE:-abc}"
export SEED_D="${SEED_D:-20260619}"

echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} SHAKE256_CASE=${SHAKE256_CASE} SEED_D=${SEED_D}"
...
echo "[SUCCESS] pass-shake256-ascendc-toy (${RUN_MODE}, case=${SHAKE256_CASE})"
