#!/bin/bash
# pass-toy-encrypt-fsm-gate-intt1：GATE CrossCore 4↔8 + INTT flag 1/3 轻量 MIX 玩具
#
...
echo "[SUCCESS] pass-toy-encrypt-fsm-gate-intt1 (${RUN_MODE}) kernel exit=0 (no correctness cmp)"
