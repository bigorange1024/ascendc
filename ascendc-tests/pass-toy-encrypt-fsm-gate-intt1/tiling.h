#ifndef PASS_TOY_ENCRYPT_FSM_GATE_INTT1_TILING_H
#define PASS_TOY_ENCRYPT_FSM_GATE_INTT1_TILING_H

/**
 * @file tiling.h
 * @brief pass-toy-encrypt-fsm-gate-intt1：GATE 4↔8 + INTT flag 1/3 玩具的维度与 workspace。
 *
 * 目标（GT-20260903-2 / Q-TOY-GATE-INTT）：验证 Encrypt 骨架「GATE 后再 INTT」
