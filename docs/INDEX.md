...
| **ML-KEM-512（P0+P1 已落）** | [specs/fips203-mlkem512-parameter-card.md](specs/fips203-mlkem512-parameter-card.md) · [P1 表](specs/fips203-mlkem512-p1-gap-and-cases.md) · [计划](research/MLKEM-512-从0到exp完整实现计划.md) |
