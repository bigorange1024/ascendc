...
| **Encrypt 卡死推理图谱** | [rg-kem-encrypt-hang.yaml](rg-kem-encrypt-hang.yaml) · [viewer HTML](rg-kem-encrypt-hang.html) · [主控↔subagent 协议](rg/AGENT_TASK_PROTOCOL.md) · 实验区 [`graph_tests/`](../graph_tests/INDEX.md) |
