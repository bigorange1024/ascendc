...
| **ML-KEM-768（P0+P1）** | [specs/fips203-mlkem768-parameter-card.md](specs/fips203-mlkem768-parameter-card.md) · [P1 用例表](specs/fips203-mlkem768-p1-gap-and-cases.md) · [计划](research/MLKEM-768-从0到exp完整实现计划.md) |
