...
| [F203-Encrypt-compute-行18-19-UB驻留技术总结.md](F203-Encrypt-compute-行18-19-UB驻留技术总结.md) | **Alg.14 compute** 内积→INTT **UB 驻留**、MIX GATE 握手、SIM 标量/MTE 可见性；[`fix-f203-alg14-lines2-18-19-21-encrypt-compute-k4`](../../ascendc-tests/fix-f203-alg14-lines2-18-19-21-encrypt-compute-k4/) |
