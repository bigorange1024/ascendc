...
- [x] **#1 单 AI Core** — 草案：**S-1**（单 cube，`blockDim=1`；cube 内可用 2 AIV；禁跨 cube 切 poly）
- [x] **#2 噪声批** — 草案：**T-B2** polyvec4；\hat A 独立 prep；禁零垫
- [x] **#3 KEM device** — 草案：**保留** D19–D21
- [x] **#4 reject / CT** — 草案：**要求** D21ct + E21ct
- [x] **#5 PKE exp** — 草案：**要做** E13–E15
- [x] **#6 命名** — 草案：`-k2`
- [x] **#7 liboqs-512 交叉** — 草案：**本阶段必达**（含修 helper）
- [x] **#8 stable-512** — 草案：**本阶段不建**
- [x] **#9 自主授权** — 草案：锁本表后 Agent **自主推进至有条件完成**；仅计划 §0.1 停问点打断
