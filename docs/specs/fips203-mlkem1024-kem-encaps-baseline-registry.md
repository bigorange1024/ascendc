...
**适用**：交付以 **`examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-kem-encaps-k4`** 为准（2026-07-15 `#验收#` 自 incubating 复制晋级）；预研副本 `examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-kem-encaps-k4` 保留。  
