...
**状态**：**P1 定稿**（2026-07-27）· **P2/P3 已实现**（W0–W4+glue 全绿；禁 stable-512）  
...
以教材为准：**缺项** = 闭包中尚未获证的先决；**补缺** = 把缺项变成已获证的过程；本文「补缺图」= 缺项与补齐策略对照表。  
只使用上述已定义术语；**勿另造**无定义同义词。
