# FIPS 203 ML-KEM-512 Alg.15 K-PKE.Decrypt — baseline-registry（骨架）

**主题**：Alg.15 Decrypt（k=2）交付/预研侧 golden / KAT 计算块登记  
**适用（目标）**：`examples/incubating/ml-kem/ml-kem-512/exp-fips203-mlkem-pke-decrypt-k2/`  
...
| Decompress / INTT | 设备算法 | 待 D15/E15 获证后登记 | 待补 |
