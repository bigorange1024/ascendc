...
| [stable-fips203-mlkem-kem-decaps-k4/](stable/stable-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 ML-KEM-1024 KEM Decaps**（k=4）：`dk`+`c`→**仅** `K`（设备 G/FO） | SIM 4 / CPU 6；SIM tick **1032762**（CPU/SIM/KAT/roundtrip ✓） | **定型交付算子** |
