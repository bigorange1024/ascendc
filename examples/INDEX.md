...
| [stable-fips203-mlkem-kem-decaps-ct-k4/](stable/stable-fips203-mlkem-kem-decaps-ct-k4/) | FIPS 203 **Alg.21 ML-KEM-1024 KEM Decaps**（k=4）：`dk`+`c`→**仅** `K`（设备 FO） | SIM `decaps_2session`；D**286829**+E**763658**（CPU/SIM ✓） | **定型交付算子** |
