#ifndef F203_STAGE2_MATMUL_HPP
#define F203_STAGE2_MATMUL_HPP
...
__aicore__ inline void RunMatmul(GM_ADDR matAGm, GM_ADDR lutGm, GM_ADDR matCGm, GM_ADDR workspaceGm, GM_ADDR tilingGm,
                                  AscendC::TPipe *pipe)
{
    (void)workspaceGm;
    using A_T = int8_t;
