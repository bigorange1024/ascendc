/**
 * @file mlkem_stage2_matmul_custom_tiling.cpp
 * f203 Stage2: C[16,512] = A[16,256] x B[256,512] int8->int32
 * Launch 由 LAUNCH_PROFILE 选择：aicore=1 / aicore=4（见 launch_profile.h）。
 */
#include <cstdint>
#include <cstdlib>
#include <iostream>
