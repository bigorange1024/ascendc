...
| [exp-fips203-mlkem-pke-decrypt-k4/](exp-fips203-mlkem-pke-decrypt-k4/) | FIPS 203 **Alg.15 PKE Decrypt** k=4（生产 input 仅 dk+c+lut→**仅 m**；单 kernel）；[customspec](exp-fips203-mlkem-pke-decrypt-k4/exp-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.pdf) | **CPU ✓ / SIM ✓** tick **283290**；注释+I/O 收紧（2026-07-09）；基线 [`pass-fix-…-device-k4`](../../ascendc-tests/pass-fix-f203-alg15-pke-decrypt-device-k4/)；待家里 KAT/roundtrip/`#交付#` |
