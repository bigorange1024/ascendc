...
| [exp-fips203-mlkem-kem-decaps-k4/](exp-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（vendored Decrypt+Encrypt；$G$ 并入 Phase-E prep；设备 FO；**T19i SIM 3**/CPU 6；仅 $K$）；[customspec](exp-fips203-mlkem-kem-decaps-k4/exp-fips203-mlkem-kem-decaps-k4-实现方案-customspec.pdf)；[STATUS](exp-fips203-mlkem-kem-decaps-k4/STATUS.md) | **已晋级** stable；**【迭代】T19i PASS**（D**286846**+E**763935**）；stable 仍 SIM 4 待镜像；基线 [`pass-fix-…-decaps-device-k4`](../../ascendc-tests/pass-fix-f203-alg21-kem-decaps-device-k4/) |
