...
| [exp-fips203-mlkem-kem-decaps-k4/](exp-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（vendored Decrypt+Encrypt；设备 FO；SIM `decaps_2session`）；[customspec](exp-fips203-mlkem-kem-decaps-k4/exp-fips203-mlkem-kem-decaps-k4-实现方案-customspec.pdf)；[STATUS](exp-fips203-mlkem-kem-decaps-k4/STATUS.md) | **已晋级** [`stable-…-kem-decaps-k4`](../stable/stable-fips203-mlkem-kem-decaps-k4/)（2026-07-24 `#交付#`）；副本保留；SIM D**286829**+E**763658**；基线 [`pass-fix-…-decaps-device-k4`](../../ascendc-tests/pass-fix-f203-alg21-kem-decaps-device-k4/) |
...
**Alg.14/15/19/20/21 交付**：[`stable-…-pke-encrypt-k4`](../stable/stable-fips203-mlkem-pke-encrypt-k4/) · [`stable-…-pke-decrypt-k4`](../stable/stable-fips203-mlkem-pke-decrypt-k4/) · [`stable-…-kem-keygen-k4`](../stable/stable-fips203-mlkem-kem-keygen-k4/) · [`stable-…-kem-encaps-k4`](../stable/stable-fips203-mlkem-kem-encaps-k4/) · [`stable-…-kem-decaps-k4`](../stable/stable-fips203-mlkem-kem-decaps-k4/)。
