...
| [exp-fips203-mlkem-kem-decaps-k4/](exp-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（vendored Decrypt+Encrypt；$G$ 并入 Phase-E prep；设备 FO；SIM 4/CPU 6；仅 $K$）；[customspec](exp-fips203-mlkem-kem-decaps-k4/exp-fips203-mlkem-kem-decaps-k4-实现方案-customspec.pdf)；[STATUS](exp-fips203-mlkem-kem-decaps-k4/STATUS.md) | **已晋级** [`stable-…-kem-decaps-k4`](../stable/stable-fips203-mlkem-kem-decaps-k4/)（2026-07-20 `#交付#`）；副本保留；tick≈**1033k**；基线 [`pass-probe-…-decaps-device-k4`](../../ascendc-tests/pass-probe-f203-alg21-kem-decaps-device-k4/) |
