...
| [exp-mlkem-f203-pke-encrypt-k4/](exp-mlkem-f203-pke-encrypt-k4/) | FIPS 203 **Alg.14 PKE Encrypt** k=4（ek+m+coins→**仅 c**；中间态禁落盘）；[customspec](exp-mlkem-f203-pke-encrypt-k4/exp-mlkem-f203-pke-encrypt-k4-实现方案-customspec.pdf) | **已晋级** [`stable-mlkem-f203-pke-encrypt-k4`](../stable/stable-mlkem-f203-pke-encrypt-k4/)；副本保留 · CPU/SIM/KAT/roundtrip ✓ · [STATUS](exp-mlkem-f203-pke-encrypt-k4/STATUS.md) |
