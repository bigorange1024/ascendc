...
| [exp-fips203-mlkem-kem-keygen-k4/](exp-fips203-mlkem-kem-keygen-k4/) | FIPS 203 **Alg.19 KEM KeyGen** k=4；[customspec](exp-fips203-mlkem-kem-keygen-k4/exp-fips203-mlkem-kem-keygen-k4-实现方案-customspec.pdf)；[STATUS](exp-fips203-mlkem-kem-keygen-k4/STATUS.md) | **有条件完成**（2026-07-14【预研】：CPU×40 + SIM tick **707057** + vs correctness×10 + liboqs×10；**未** `#交付#`） |
...
**Alg.14/15 PKE 交付**：[`stable-fips203-mlkem-pke-encrypt-k4`](../stable/stable-fips203-mlkem-pke-encrypt-k4/) · [`stable-fips203-mlkem-pke-decrypt-k4`](../stable/stable-fips203-mlkem-pke-decrypt-k4/)（原 correctness 探针已冻结）。
