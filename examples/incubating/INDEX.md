...
| [exp-fips203-mlkem-kem-encaps-k4/](exp-fips203-mlkem-kem-encaps-k4/) | FIPS 203 **Alg.20 KEM Encaps** k=4（prep 前段 H/G + vendored Encrypt；$m$ GM 入；$c$+$K$）；[customspec](exp-fips203-mlkem-kem-encaps-k4/exp-fips203-mlkem-kem-encaps-k4-实现方案-customspec.pdf)；[STATUS](exp-fips203-mlkem-kem-encaps-k4/STATUS.md) | **CPU ✓ / SIM ✓** tick≈**721k**（2026-07-15【预研】）；基线 [`pass-fix-…-encaps-device-k4`](../../ascendc-tests/pass-fix-f203-alg20-kem-encaps-device-k4/) |
