...
| [exp-fips203-mlkem-kem-decaps-k4/](exp-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（vendored Decrypt+Encrypt；$G$ 并入 Phase-E prep；设备 FO；SIM 4/CPU 6；仅 $K$）；[customspec](exp-fips203-mlkem-kem-decaps-k4/exp-fips203-mlkem-kem-decaps-k4-实现方案-customspec.pdf)；[STATUS](exp-fips203-mlkem-kem-decaps-k4/STATUS.md) | **CPU ✓ / SIM ✓** + **roundtrip CPU/SIM ✓**（2026-07-20）；`scripts/` Decaps 默认已指；D**286999**+E**745790** |
