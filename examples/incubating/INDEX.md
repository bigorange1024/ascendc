...
| [exp-fips203-mlkem-kem-keygen-k4/](exp-fips203-mlkem-kem-keygen-k4/) | FIPS 203 **Alg.19 KEM KeyGen** k=4；[customspec](exp-fips203-mlkem-kem-keygen-k4/exp-fips203-mlkem-kem-keygen-k4-实现方案-customspec.pdf)（含 §踩坑 SyncAll） | **仅规格**（2026-07-13 实现树已删；待【预研】按 PDF 从零重写；**无** stable） |
