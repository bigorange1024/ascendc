#!/usr/bin/env bash
# exp-fips203-compress-unified-int-vec-k4 — 统一整数舍入 Compress_d（d=1/4/5/10/11）
#
# 规格：exp-fips203-compress-unified-int-vec-k4-实现方案-customspec.pdf
# 默认 COMPRESS_UNIFIED_INT_VEC=1（纯 int32 向量 limb 宽乘）；=0 为 int64 lane 对照
...
echo "[SUCCESS] exp-fips203-compress-unified-int-vec-k4 d=${F203_UNIFIED_ROUND_D} (${RUN_MODE})"
