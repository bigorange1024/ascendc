#!/usr/bin/env bash
# exp-fips203-mlkem-kem-decaps-k4 — FIPS 203 Alg.21/18 Decaps（vendored D+E + 设备 G/FO）
#
...
ln -sfn ../../../stable/stable-fips203-mlkem-pke-encrypt-k4/scripts/host_golden "${CURRENT_DIR}/scripts/host_golden"
ln -sfn ../../../stable/stable-fips203-mlkem-pke-encrypt-k4/thirdparty "${CURRENT_DIR}/thirdparty"
