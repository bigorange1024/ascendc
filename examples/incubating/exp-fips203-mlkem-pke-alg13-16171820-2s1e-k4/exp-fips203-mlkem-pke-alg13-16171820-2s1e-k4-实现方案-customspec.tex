...
\begin{abstract}
本文档为 \dirname{examples/incubating/exp-fips203-mlkem-pke-alg13-16171820-2s1e-k4/} 的\textbf{实现规格说明书}（customspec）。
...
项 & 内容 \\
\midrule
用例路径 & \dirname{examples/incubating/exp-fips203-mlkem-pke-alg13-16171820-2s1e-k4/} \\
