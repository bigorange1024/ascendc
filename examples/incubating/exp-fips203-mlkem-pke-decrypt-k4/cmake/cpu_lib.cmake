...
target_include_directories(ascendc_kernels_${RUN_MODE} PRIVATE
    ${TEST_ROOT} ${G4_FULL_INC} ${UNPACK_INC} ${PREP_DECODE_INC} ${NTT_U_INC} ${INTT_W_INC} ${ALG11_INC} ${SU_DOT_INC} ${FINAL_INC} ${TAIL_C1_INC})
