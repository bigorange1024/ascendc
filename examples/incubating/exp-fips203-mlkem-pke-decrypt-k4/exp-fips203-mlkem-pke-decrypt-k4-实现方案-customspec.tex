% exp-fips203-mlkem-pke-decrypt-k4 — FIPS 203 Alg.15 ML-KEM-1024 PKE Decrypt (k=4)
% 编译：bash ../../../scripts/xelatex-clean.sh exp-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.tex
...
\title{exp-fips203-mlkem-pke-decrypt-k4\\FIPS 203 Alg.15 ML-KEM-1024 PKE Decrypt 实现方案（k=4）}
...
\begin{abstract}
本文档描述 \textbf{预研用例} \dirname{examples/incubating/exp-fips203-mlkem-pke-decrypt-k4/}：
...
\begin{verbatim}
exp-fips203-mlkem-pke-decrypt-k4/
  exp-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.tex/.pdf  # 本规格
...
\dirname{ascendc-tests/pass-fix-f203-alg15-pke-decrypt-device-k4/}。
...
\begin{enumerate}
  ...
  \item 活跃 customspec：\dirname{examples/incubating/exp-fips203-mlkem-pke-decrypt-k4/exp-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.tex}（及同名 PDF）。
  \item 晋级 \dirname{examples/stable/stable-fips203-mlkem-pke-decrypt-k4} 须另走 \texttt{\#交付\#}（T15a），且须 baseline-registry 齐备。
\end{enumerate}
