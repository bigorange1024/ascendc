...
__attribute__((weak)) __gm__ const int32_t gAlg11GammasGm[ALG11_PAIR_COUNT] = {ALG11_GAMMAS_TABLE};
__attribute__((weak)) __gm__ const int32_t gAlg11GatherEvenByteGm[ALG11_PAIR_COUNT] = {ALG11_GATHER_EVEN_BYTE_TABLE};
__attribute__((weak)) __gm__ const int32_t gAlg11GatherOddByteGm[ALG11_PAIR_COUNT] = {ALG11_GATHER_ODD_BYTE_TABLE};
__attribute__((weak)) __gm__ const int32_t gAlg11InterleaveReorderByteGm[ALG11_PAIR_COUNT * 2] = {
    ALG11_INTERLEAVE_REORDER_BYTE_TABLE};
