% exp-fips203-mlkem-pke-keygen-k4 — FIPS 203 Alg.13 ML-KEM-768 KeyGen (k=4)
% 编译：bash ../../../scripts/xelatex-clean.sh exp-fips203-mlkem-pke-keygen-k4-实现方案-customspec.tex
...
\title{exp-fips203-mlkem-pke-keygen-k4\\FIPS 203 Alg.13 ML-KEM-768 PKE KeyGen 实现方案（k=4）}
...
\begin{abstract}
本文档描述 \textbf{交付示例} \dirname{examples/incubating/exp-fips203-mlkem-pke-keygen-k4/}：
...
\begin{verbatim}
exp-fips203-mlkem-pke-keygen-k4/
