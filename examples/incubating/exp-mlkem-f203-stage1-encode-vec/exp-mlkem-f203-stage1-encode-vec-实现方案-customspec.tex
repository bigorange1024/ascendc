% exp-mlkem-f203-stage1-encode-vec 纯向量 Stage1 实现方案
% 编译：bash ../../../../scripts/xelatex-clean.sh exp-mlkem-f203-stage1-encode-vec-实现方案-customspec.tex
...
\title{exp-mlkem-f203-stage1-encode-vec\\F203 Stage1 纯向量实现方案（API 全覆盖评估）}
...
\begin{abstract}
本文档描述 \texttt{examples/incubating/exp-mlkem-f203-stage1-encode-vec/} 用例：
