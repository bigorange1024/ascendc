% exp-mlkem-f203-stage3-routea-mod-vec Stage3 向量预研实现方案
% 编译：bash ../../../../scripts/xelatex-clean.sh exp-mlkem-f203-stage3-routea-mod-vec-实现方案-customspec.tex
...
\title{exp-mlkem-f203-stage3-routea-mod-vec\\F203 Stage3 RouteA + mod $q$ 向量预研方案}
...
\begin{abstract}
本文档为 \texttt{exp-mlkem-f203-stage3-routea-mod-vec/} 的\textbf{计划书闭环}：
