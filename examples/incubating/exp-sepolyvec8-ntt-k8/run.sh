#!/bin/bash
# exp-sepolyvec8-ntt-k8: k=8 batch NTT (merged_kyber FSM)
# Usage:
...
echo "SOC=${SOC_VERSION} RUN_MODE=${RUN_MODE} SIM_DIRECT=${SIM_DIRECT} (exp sepolyvec8 k=8)"
...
echo "[SUCCESS] exp-sepolyvec8-ntt-k8 (${RUN_MODE})"
