/**
 * @file main.cpp
 * @brief 统一整数 Compress_d exp 探针 host：input/poly.bin → kernel → output/comp.bin。
 *
...
#include "acl/acl.h"
#include "aclrtlaunch_compress_unified_int_custom.h"
#else
#include "tikicpulib.h"
#ifndef GM_ADDR
#define GM_ADDR int8_t *
#endif
extern "C" void compress_unified_int_custom(GM_ADDR poly_in, GM_ADDR comp_out, int32_t coeff_n);
#endif
...
int32_t main(int32_t argc, char *argv[])
{
    ...
    ICPU_RUN_KF(compress_unified_int_custom, blockDim, poly_in, comp_out, F203_MLKEM_N);
    ...
    ACLRT_LAUNCH_KERNEL(compress_unified_int_custom)(blockDim, stream, polyDevice, compDevice, F203_MLKEM_N);
