#!/usr/bin/env python3
"""
gen_data.py — Alg.21 Decaps **全链** golden 与 input 生成（exp-fips203-mlkem-kem-decaps-ct-k4）。
...
## 路径解析（exp 自包含）
ROOT = 本用例目录；REPO = examples/incubating/exp-* 上溯三级到仓库根。
...
# 用例根：examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-kem-decaps-ct-k4/
ROOT = Path(__file__).resolve().parent.parent
# exp-* → incubating → examples → repo 根
