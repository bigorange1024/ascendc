#!/usr/bin/env python3
"""
gen_data.py — Alg.21 Decaps **全链** golden 与 input 生成（exp-fips203-mlkem-kem-decaps-k4）。
...
# 用例根：examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-kem-decaps-k4/
