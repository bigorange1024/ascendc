...
| 项 | 值 |
|----|-----|
| **基线** | [`pass-fix-f203-alg15-pke-decrypt-device-k4`](../../../ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg15-pke-decrypt-device-k4/) |
...
```bash
cd examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-pke-decrypt-k4
