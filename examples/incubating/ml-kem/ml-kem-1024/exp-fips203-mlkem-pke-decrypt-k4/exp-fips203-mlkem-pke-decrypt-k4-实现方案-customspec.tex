...
\begin{abstract}
本文档描述 \textbf{预研用例} \dirname{examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-pke-decrypt-k4/}：
...
\begin{enumerate}
  ...
  \item 活跃 customspec：\dirname{examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-pke-decrypt-k4/exp-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.tex}（及同名 PDF）。
