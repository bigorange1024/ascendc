# 自包含与设备全链约束 — exp-fips203-mlkem-pke-encrypt-k4

**customspec**：[`exp-fips203-mlkem-pke-encrypt-k4-实现方案-customspec.tex`](exp-fips203-mlkem-pke-encrypt-k4-实现方案-customspec.tex)  
**交付副本**：[`stable-fips203-mlkem-pke-encrypt-k4`](../../stable/stable-fips203-mlkem-pke-encrypt-k4/)  
...
**规则**：实现自 [`pass-fix-f203-alg14-pke-encrypt-device-k4`](../../../ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg14-pke-encrypt-device-k4/) **一次性 vendor**；写码后切断外链。`alg11_*` / `multiply_ntts_*` 已抄入 `compute/`。
