# INTEGRATION_PLAN — exp-fips203-mlkem-kem-decaps-ct-k2
...
| 路径 | 角色 |
|------|------|
| [`exp-fips203-mlkem-kem-decaps-ct-k2`](../exp-fips203-mlkem-kem-decaps-ct-k2/) | Phase-D Decrypt 权威 |
| [`exp-fips203-mlkem-kem-decaps-ct-k2`](../exp-fips203-mlkem-kem-decaps-ct-k2/) | Phase-E Encrypt 权威 |
...
```bash
cd ascendc-tests/ml-kem/ml-kem-512/exp-fips203-mlkem-kem-decaps-ct-k2
...
本探针 CMake 现将 `COMPUTE_DIR` 指到 [`exp-fips203-mlkem-kem-decaps-ct-k2/compute`](../exp-fips203-mlkem-kem-decaps-ct-k2/compute/)。**禁止**在该共享树上改 `f203_encrypt_l18_l19_kernel.cpp` 签名或行为（Encaps / PKE Encrypt 同编此文件）。
