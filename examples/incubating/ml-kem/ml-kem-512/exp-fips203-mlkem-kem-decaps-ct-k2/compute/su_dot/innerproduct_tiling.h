 ...
 *
 * 默认 ML-KEM-512 Decrypt 内积：P_OUT=1、S_VEC=3、N=256、blockDim=1。
 * 可用 CMake/宏 INNERPRODUCT_P_OUT、INNERPRODUCT_S_VEC 覆写做局部对照。
 */
#pragma once
...
/** ML-KEM-512 Decrypt：输出 ŵ 单 poly，输入 ŝ/û 为 k=2 polyvec。 */
