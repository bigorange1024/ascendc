# INTEGRATION_PLAN — exp-fips203-mlkem-kem-encaps-k2
...
| 路径 | 角色 |
|------|------|
| [`../exp-fips203-mlkem-kem-encaps-k2/`](../exp-fips203-mlkem-kem-encaps-k2/) | D14 PKE Encrypt k2 绿树：prep、compute、tail、host golden |
...
```bash
cd ascendc-tests/ml-kem/ml-kem-512/exp-fips203-mlkem-kem-encaps-k2
