 ...
 *
 * ## 对齐
 * FIPS 203 Alg.13，ML-KEM-512（k=2）；与 golden 仅 I/O 等价（中间 GM 不落盘）。
 *
 * ## Launch
 ...
 * @param a_hat_gm        输出 GM：Â[4,256] int32 行主序
 * @param prf_out_gm      中间 GM：PRF [4,192] uint8（CBD_η=3 输入）
 * @param src_gm          输出 GM：ŝ‖ê [4,256] int32
