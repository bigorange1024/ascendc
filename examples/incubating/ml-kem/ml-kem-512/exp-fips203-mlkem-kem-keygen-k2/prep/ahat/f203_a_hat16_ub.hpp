 ...
 * @brief Alg.13 行 3–7：4×（SHAKE + 向量 d12/rej），UB 全链，链末写 GM a_hat[4,256]。
 *
...
/** D13 锁定：Â[4] 由双 AIV 按 2+2 分片，禁止补到 6/8/16。 */
...
/** 填单分片 batch 消息；2 AIV 时最大 batch=2，等价于 range(0, kShakeActiveBatch)。 */
