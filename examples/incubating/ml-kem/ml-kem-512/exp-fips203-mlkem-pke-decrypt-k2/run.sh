#!/usr/bin/env bash
# exp-fips203-mlkem-pke-decrypt-k2 — ML-KEM-512 FIPS 203 Alg.15 PKE Decrypt（fused）
#
# 生产 I/O：
...
echo "[SUCCESS] exp-fips203-mlkem-pke-decrypt-k2 (${RUN_MODE}) DECRYPT_VERIFY=${DECRYPT_VERIFY} COMPRESS_1_VEC=${COMPRESS_1_VEC:-1} DECOMPRESS_D_VEC=${DECOMPRESS_D_VEC:-1}"
