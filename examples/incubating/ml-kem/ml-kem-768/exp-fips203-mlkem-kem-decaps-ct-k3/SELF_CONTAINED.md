# 自包含与设备全链约束 — exp-fips203-mlkem-kem-decaps-ct-k3

本目录为 **Alg.21 ML-KEM-768 KEM Decaps CT** incubating 实现。Phase-D 来自本目录 vendored E15/D15 Decrypt，Phase-E 来自本目录 vendored E14/D14 Encrypt，KEM 增量在 `kem/`；SIM 默认锁定 `decaps_2session`。
...
output/ K.bin(32)；reject 必须等于 J(z‖c) 且不同于 accept K
```
