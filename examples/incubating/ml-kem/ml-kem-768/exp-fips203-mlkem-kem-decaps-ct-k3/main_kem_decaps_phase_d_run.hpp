 ...
 * @brief Phase-D Host API：D15 k3 Decrypt fused；dk_kem 前缀即 dk_pke。
 *
 * 见 `main_kem_decaps_phase_d_run.cpp`。SIM 本段自含 aclInit…aclFinalize（decaps_2session 对照路径第一段）。
 */
#pragma once
 ...
 *
 * @param dk_kem        2400B；设备只读前缀 [0:1152) 作 dk_pke
 * @param c             1088B 密文
