 ...
 *
 * 流水线：ML-KEM-768 D14 prep 复用 k3 D13/B4 Â 组件；XOF/d12/rej 常量与
 * pass-fix-f203-alg7-sample-ntt-k3 的 f203_alg7_layout.h 同值。
 *
 * GM 布局与参数卡 §3.2 一致：Â[9,256]，无 16-poly padding。
 */
#pragma once
