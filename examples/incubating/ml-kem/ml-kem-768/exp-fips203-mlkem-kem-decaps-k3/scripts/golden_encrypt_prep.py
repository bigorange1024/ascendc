#!/usr/bin/env python3
# coding=utf-8
"""本 exp 自包含 golden 原语（Alg.7 SampleNTT + Alg.14 PRF/CBD）。
...
代码按活跃 D14 k3 行为基线核对后本地化到本目录；禁止 import 其它 ascendc-tests 用例或 library/shared。
...
def shake128_squeeze(msg: bytes, outlen: int) -> bytes:
    """SHAKE128 固定长度 squeeze（本 exp XOF_BYTES=672）。"""
