 ...
 * @brief Alg.13 行 3–7 设备核：SEED_D → 向量 SampleNTT → a_hat[9,256] GM（1 或 2 AIV）。
 */
...
/*
 * blockDim 语义（SIM/NPU）：
 * - BLOCK_DIM=2：AIV0→poly 0–4，AIV1→5–8；每 poly 内嵌 SHAKE 须 ProcessInline（见 shake_ub_helpers.hpp）。
