...
| [stable-fips203-mlkem-kem-decaps-ct-k4/](stable-fips203-mlkem-kem-decaps-ct-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（`dk`+`c`→**仅** `K`；SIM `decaps_2session`；设备 FO）；[customspec](stable-fips203-mlkem-kem-decaps-ct-k4/stable-fips203-mlkem-kem-decaps-ct-k4-实现方案-customspec.pdf) | v1 | 自 [`exp-fips203-mlkem-kem-decaps-ct-k4`](../incubating/exp-fips203-mlkem-kem-decaps-ct-k4/) 晋级（2026-07-24 `#交付#`）；SIM D**286829**+E**763658**；[registry](../../docs/specs/fips203-mlkem1024-kem-decaps-baseline-registry.md) |
