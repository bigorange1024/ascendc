...
| [stable-fips203-mlkem-kem-decaps-k4/](stable-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（SIM 4 / CPU 6；`dk`+`c`→**仅** `K`；设备 G/FO）；[customspec](stable-fips203-mlkem-kem-decaps-k4/stable-fips203-mlkem-kem-decaps-k4-实现方案-customspec.pdf) | v1 | 自 [`exp-fips203-mlkem-kem-decaps-k4`](../incubating/exp-fips203-mlkem-kem-decaps-k4/) 晋级（2026-07-20 `#交付#`）；SIM tick **1032762**；KAT 10+3 / roundtrip ✓；[registry](../../docs/specs/fips203-mlkem1024-kem-decaps-baseline-registry.md) |
