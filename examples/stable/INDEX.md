...
| [stable-fips203-mlkem-kem-decaps-k4/](stable-fips203-mlkem-kem-decaps-k4/) | FIPS 203 **Alg.21 KEM Decaps** k=4（**T19i SIM 3** / CPU 6；`dk`+`c`→**仅** `K`；设备 G/FO）；[customspec](stable-fips203-mlkem-kem-decaps-k4/stable-fips203-mlkem-kem-decaps-k4-实现方案-customspec.pdf) | v1 | 自 exp 晋级；**T19i `#修改#` PASS**（D**286851**+E**763769**；KAT 10+3 / roundtrip ✓）；[registry](../../docs/specs/fips203-mlkem1024-kem-decaps-baseline-registry.md) |
