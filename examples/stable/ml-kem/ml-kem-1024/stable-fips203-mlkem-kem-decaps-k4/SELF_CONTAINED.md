...
**定型交付**（2026-07-20 `#交付#`）：自 `examples/incubating/ml-kem/ml-kem-1024/exp-fips203-mlkem-kem-decaps-k4` **复制**晋级；预研副本保留。
...
行为基线（只读）：[`pass-fix-f203-alg21-kem-decaps-device-k4`](../../../ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg21-kem-decaps-device-k4/)。
