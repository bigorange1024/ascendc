# SELF_CONTAINED — stable-fips203-mlkem-kem-keygen-k4

本目录为 **自包含** Alg.19 KEM KeyGen **定型交付**实现（customspec 强制）。
...
| 规格 | `stable-…-实现方案-customspec.{tex,pdf}` |
| 第三方 LUT | `thirdparty/ntt_onnx`（与仓 `thirdparty/` 对齐） |
| 来源 | 2026-07-14 自 `exp-fips203-mlkem-kem-keygen-k4` **复制**晋级 |
