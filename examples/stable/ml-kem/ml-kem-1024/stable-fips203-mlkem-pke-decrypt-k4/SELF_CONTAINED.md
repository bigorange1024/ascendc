# 自包含与设备全链约束 — stable-fips203-mlkem-pke-decrypt-k4

**customspec**：[`stable-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.tex`](stable-fips203-mlkem-pke-decrypt-k4-实现方案-customspec.tex)  
**基线探针**：[`pass-fix-f203-alg15-pke-decrypt-device-k4`](../../../ascendc-tests/ml-kem/ml-kem-1024/pass-fix-f203-alg15-pke-decrypt-device-k4/)（一次性 vendor）  
