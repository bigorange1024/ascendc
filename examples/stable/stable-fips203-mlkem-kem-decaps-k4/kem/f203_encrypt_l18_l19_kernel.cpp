 ...
 * @brief stable Decaps 本地覆盖：Alg.14 SIM 融合 MIX + 内联 pack；同核 Alg.18 FO（T19i）。
 *
 * 对齐 stable customspec T19i #修改# 与 incubating/pass-fix；本目录 CMake 编此 TU，覆盖 compute/ 同名核；禁止回写共享 Encrypt 树。
