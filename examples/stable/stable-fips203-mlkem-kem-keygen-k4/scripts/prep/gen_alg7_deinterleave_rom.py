...
# @probe pass-fix-f203-alg19-kem-keygen-device-k4
# @file scripts/prep/gen_alg7_deinterleave_rom.py
# @note ROM 输出到 **本探针** prep/alg7/（不写 stable）；逻辑与 stable 同型，alg7_geom 经 PYTHONPATH 引用。
# @layer script
...
def main() -> None:
    ...
    body = [
        ...
        " * 生成：device-k4 scripts/prep/gen_alg7_deinterleave_rom.py",
        " */",
        "#pragma once",
        "",
        "#include <cstdint>",
