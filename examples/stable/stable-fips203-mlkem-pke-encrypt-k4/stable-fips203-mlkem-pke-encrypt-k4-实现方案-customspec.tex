...
\begin{abstract}
本文档描述 \textbf{定型交付算子} \dirname{examples/stable/stable-fips203-mlkem-pke-encrypt-k4/}：
...
\begin{enumerate}
  ...
  \item 活跃 customspec：\dirname{examples/stable/stable-fips203-mlkem-pke-encrypt-k4/stable-fips203-mlkem-pke-encrypt-k4-实现方案-customspec.tex}（及同名 PDF）。
