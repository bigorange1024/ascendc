# 自包含与设备全链约束 — stable-mlkem-f203-pke-encrypt-k4

**customspec**：[`stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.tex`](stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.tex)  
