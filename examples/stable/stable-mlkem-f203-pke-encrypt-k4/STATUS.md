# STATUS — stable-mlkem-f203-pke-encrypt-k4

**语义**：FIPS 203 **Alg.14 全链 K-PKE.Encrypt**（k=4，ML-KEM-1024 PKE）— **stable 定型交付算子**（自 `exp-mlkem-f203-pke-encrypt-k4` 复制晋级，2026-07-09）。

**实现方案**：[`stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.pdf`](stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.pdf)  
...
**预研副本**：[`exp-mlkem-f203-pke-encrypt-k4`](../../incubating/exp-mlkem-f203-pke-encrypt-k4/)（保留）  
