#!/usr/bin/env bash
# exp-mlkem-f203-pke-encrypt-k4 — 完整 K-PKE.Encrypt（FIPS 203 Alg.14 行 1–22）
#
# customspec：exp-mlkem-f203-pke-encrypt-k4-实现方案-customspec.tex
...
PY
    echo "[SUCCESS] stable-mlkem-f203-pke-encrypt-k4 (${RUN_MODE})"
fi
