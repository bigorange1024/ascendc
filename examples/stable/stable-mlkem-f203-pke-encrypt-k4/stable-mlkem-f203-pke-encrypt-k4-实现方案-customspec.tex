% stable-mlkem-f203-pke-encrypt-k4 — FIPS 203 Alg.14 ML-KEM-1024 PKE Encrypt (k=4)
% 编译：bash ../../../scripts/xelatex-clean.sh stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.tex
...
\title{stable-mlkem-f203-pke-encrypt-k4\\FIPS 203 Alg.14 ML-KEM-1024 PKE Encrypt 实现方案（k=4）}
...
\begin{abstract}
本文档描述 \textbf{定型交付算子} \dirname{examples/stable/stable-mlkem-f203-pke-encrypt-k4/}：
...
\begin{verbatim}
stable-mlkem-f203-pke-encrypt-k4/
  stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.tex/.pdf  # 本规格
...
\begin{enumerate}
  ...
  \item 活跃 customspec：\dirname{examples/stable/stable-mlkem-f203-pke-encrypt-k4/stable-mlkem-f203-pke-encrypt-k4-实现方案-customspec.tex}（及同名 PDF）。
