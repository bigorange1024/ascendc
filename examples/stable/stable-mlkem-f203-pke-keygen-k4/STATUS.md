# STATUS — stable-mlkem-f203-pke-keygen-k4

**语义**：FIPS 203 **Alg.13 全链 KeyGen**（k=4，ML-KEM-768 PKE）— **stable 定型交付算子**（自 `exp-mlkem-f203-pke-keygen-k4` 复制晋级，2026-06-29）。

**实现方案**：[`stable-mlkem-f203-pke-keygen-k4-实现方案-customspec.pdf`](stable-mlkem-f203-pke-keygen-k4-实现方案-customspec.pdf)
