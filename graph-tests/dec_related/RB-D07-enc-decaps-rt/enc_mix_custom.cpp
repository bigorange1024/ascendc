/**
 * @file enc_mix_custom.cpp
 * @brief RB-D07 Launch2 MIX：握手 + μ←m' + Decode₁₂→CBD→Â/ŷ→Mul/INTT→pack→c'。
 *
 ...
 */
extern "C" __global__ __aicore__ void enc_mix_custom(GM_ADDR out, GM_ADDR cOut, GM_ADDR ws,
                                                     TilingData tiling)
{
    (void)tiling;
