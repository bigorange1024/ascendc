#!/usr/bin/python3
# coding=utf-8
# EN04-matvec-realbrick · 五段造数
# L1/L5：独立随机 int32 块（桩段不对 golden）
# L2/L4：沿用 EN02 正向 NTT / 逆向 INTT 矩阵与 golden
# L3：真 NTT 域 4×4×1 内积（Â、ŝ、γ + golden_t_hat）
...
def gen_forward_ntt():
    ...
    if ref not in ("kyber", "ml-kem", "mlkem"):
        raise ValueError(f"EN04 锁定 NTT_REF=kyber，收到 {ref!r}")
...
if __name__ == "__main__":
    ...
    print("[OK] EN04 five-segment inputs written")
