#!/usr/bin/python3
# coding=utf-8
# EN04：软对拍 NTT/INTT/Matvec；Prep/Pack 桩不对 golden（正确性非主门禁）
...
if __name__ == "__main__":
    try:
        ...
        if not (ok_ntt and ok_matvec and ok_intt):
            raise ValueError("[ERROR] NTT/Matvec/INTT golden mismatch")
        print("test pass (NTT+Matvec+INTT soft); Prep/Pack stubs not compared")
