/**
 * EN06 · AIV 段共用脚手架（沿用 X32）
 *
 * 背景：Prep=真 CBD、Matvec=真积木、Pack=真 Compress+ByteEncode；均独立 AIV launch（KB A2/X32）。
 ...
 * 未采用：把 Pack/Prep/Matvec 融进 NTT MIX 胖核；照抄 Encrypt/alg14/ER 核。
 */
