...
# coding=utf-8
"""
EP04：硬门禁 — c/K vs liboqs Encaps（scripts/liboqs_kem_vs_ascendc_verify.py）。
"""
...
def main() -> int:
    ...
    if rc != 0:
        ...
        print(f"[EP04] HARD FAIL c_max={mx_c} K_max={mx_k}")
        return 1
    print("[EP04] HARD PASS c/K vs liboqs Encaps max=0")
    print("test pass (EP04 Encaps × liboqs)")
    return 0
