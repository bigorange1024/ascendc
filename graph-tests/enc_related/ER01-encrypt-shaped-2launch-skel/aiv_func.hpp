#ifndef ER01_ENCRYPT_SHAPED_2LAUNCH_SKEL_AIV_FUNC_HPP
#define ER01_ENCRYPT_SHAPED_2LAUNCH_SKEL_AIV_FUNC_HPP
 ...
 * @brief GATE 段真积木：有界 int32 Vec MAC（T06 级；禁 X14 假循环）。
 */
class AivGateRealBrickMac {
public:
...
#endif /* ER01_ENCRYPT_SHAPED_2LAUNCH_SKEL_AIV_FUNC_HPP */
