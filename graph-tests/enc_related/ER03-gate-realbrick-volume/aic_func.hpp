 ...
 *
 * ER03：Cube 体量与 ER01 相同（本刀不加 Cube）；仅 GATE Vec MAC 加压。
 * 流水线位置：AIC 在 CrossCore WAIT(1) 之后、SET(3) 之前调用，给握手提供
 * 「真 Cube 活」；形状取 int8 Cube 最小粒度，避免 SIM 过慢。
 * API：DataCopy+Nd2Nz / LoadData / LoadDataWithTranspose / Mmad / Fixpipe
 * （查阅索引 GT-20260903-1 已有记录，本玩具复用；无新增 API）。
 */
#ifndef ER03_GATE_REALBRICK_VOLUME_AIC_FUNC_HPP
#define ER03_GATE_REALBRICK_VOLUME_AIC_FUNC_HPP
...
#endif /* ER03_GATE_REALBRICK_VOLUME_AIC_FUNC_HPP */
