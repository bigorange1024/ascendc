 ...
 * @brief RB-T14 设备侧：FIPS 203 Alg.9 正向 NTT（poly-batch，整 poly）。
 *
 ...
 */
#ifndef RB_T14_NTT_DEVICE_MATH_HPP
#define RB_T14_NTT_DEVICE_MATH_HPP
 ...
 * @param yHatOut 独立落盘缓冲（与 OFF_Y_HAT 同内容）
 *
