#!/bin/bash
# RB-T16-device-cbd-y-e：设备 MIX coins→(y,e₁,e₂)（Alg.8 CBD η=2；接 T07 coins）
#
...
#
# 防挂死：KERNEL_COMPUTE_BUDGET_SEC 默认 cpu=300 / sim=600（PRF+CBD×9+MIX）
...
echo "[SUCCESS] RB-T16-device-cbd-y-e (${RUN_MODE})"
