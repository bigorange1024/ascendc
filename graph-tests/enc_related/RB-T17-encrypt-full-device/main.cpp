/**
 * @file main.cpp
 * @brief RB-T17 Host：双 launch — prep(AIV: coins+ρ) → Synchronize → compute(MIX 全设备链)。
 *
 * Host 预喂：ek/coins/μ/t̂/ζ/γ/mat；禁预填最终 y/e/Â/ŷ/u/v/c。
...
/**
 * 装填 Host 侧 ws：t̂/μ/ζ/γ + mat；清零 Â/ŷ/YEE/u/v/c。
 * coins 由独立 buffer 进 prep；此处不写最终噪声/密文。
 */
