...
# -*- coding: utf-8 -*-
"""
RB-T19 verify：PASS_SYNC（主）/ PASS_IO（c/u/v/Â/ŷ/t̂/yee/ρ）。

PASS_SYNC 硬槽含 BD12_DONE + CBD_DONE；out 魔数 T19=0x543F0013。
"""
...
def main() -> int:
    ...
    if io_ok:
        print("[SUCCESS] PASS_SYNC + PASS_IO — RB-T19 encrypt-ek-decode-full")
    else:
