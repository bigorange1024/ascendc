 ...
 * @brief RB-T21 Launch2：握手 + μ←Decompress₁(m) + Decode₁₂→CBD→Â/ŷ→Mul/INTT→pack→c。
 *
 * 相对 T20：μ 由设备 T04 契约从 Host 预装的 m 嵌入（禁 Host 预喂最终 μ）。
 * 生产 Encrypt 全设备外形（禁 Host 预喂最终 t̂/y/e/Â/ŷ/u/v/c/μ）：
