/**
 * @file tiling.h
 * @brief RB-T23：T22 设备 Encaps + liboqs ML-KEM-1024 交叉对拍 c/K。
 *
 ...
 */
#ifndef RB_T23_ENCAPS_LIBOQS_CROSS_TILING_H
#define RB_T23_ENCAPS_LIBOQS_CROSS_TILING_H
...
constexpr uint32_t MAGIC_OUT_OK = 0x543F0017u;         // T23
constexpr uint32_t MAGIC_PREP_MARK = 0x543F5156u;      // T23P
