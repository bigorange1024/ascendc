/**
 * @file main.cpp
 * @brief RB-T24 Host：T23 设备 Encaps + liboqs Decaps(sk,c)→K' ≡ K。
 *
 * Encaps：
 ...
 *   - 验收：liboqs Decaps(sk,c)→K' 与 K 对拍；缺库勿假绿
 *
...
int32_t main(int32_t argc, char *argv[])
{
    ...
    INFO_LOG("Host: Encaps→Decaps RT; Launch1 prep_custom (CPU AIV twin)");
    ...
    INFO_LOG("Host: Encaps→Decaps RT; Launch1 prep_custom (SIM/NPU)");
