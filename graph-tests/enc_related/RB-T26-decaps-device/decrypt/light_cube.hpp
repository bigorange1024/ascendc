/**
 * @file light_cube.hpp
 * @brief RB-T25 极轻 Cube：单趟 16×32×32 int8→int32 MMAD（握手段有界真算）。
 *
 * 作用：NTT / INTT 各 launch 的 AIC 路径各调用一次；与 Decrypt 数学无关。
 * API：既有 DataCopy(Nd2Nz)/LoadData/Mmad/Fixpipe（查阅索引已登记）。
 */
#ifndef RB_T25_LIGHT_CUBE_HPP
#define RB_T25_LIGHT_CUBE_HPP
