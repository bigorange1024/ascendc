...
# -*- coding: utf-8 -*-
"""
RB-T28 verify：K ≡ liboqs Decaps；Decrypt/Reenc TRACE 因果；out magic。
"""
...
MAGIC_OUT = 0x543F001C

# Decrypt TRACE（相对 dec_tiling slots）
DEC_HARD = {
...
# Encaps TRACE（相对 enc_tiling；主路径 AIV0）
ENC_HARD = {
    1: 0x50524550,  # PREP_DONE
...
def main() -> int:
    ...
    print("[SUCCESS] PASS_SYNC + PASS_IO — RB-T28 decaps 4-launch")
    return 0
