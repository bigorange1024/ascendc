...
| [`RB-K07-pke-2launch`](RB-K07-pke-2launch/) | LR-KG-F1 | **PASS_NPU×30**（Host 2；Σ Task Duration 1127µs · [PERF](../launch-reduce-ops/PERF.md)） |
| [`RB-K08-kem-3launch`](RB-K08-kem-3launch/) | LR-KG-F2b | **PASS_NPU×30**（KEM 4→3） |
| [`RB-K09-kem-2launch`](RB-K09-kem-2launch/) | LR-KG-F2 | **PASS_NPU×30**（Host 2；Σ 1227µs · [PERF](../launch-reduce-ops/PERF.md)） |
