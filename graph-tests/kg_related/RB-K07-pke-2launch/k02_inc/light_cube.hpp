...
/**
 * @file light_cube.hpp
 * @brief RB-K02 极轻 Cube：单趟 16×32×32 int8→int32 MMAD（无算法正确性要求）。
 *
 * 作用：NTT 握手段调用一次，证明为有界真计算（非空转）。
 ...
 */
#ifndef RB_K02_LIGHT_CUBE_HPP
#define RB_K02_LIGHT_CUBE_HPP
 ...
 * 与 NTT(ŝ/ê) golden 无关；仅要求 SIM/CPU 不挂死。
 */
class LightCube {
public:
