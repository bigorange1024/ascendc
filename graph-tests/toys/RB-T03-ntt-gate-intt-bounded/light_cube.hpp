/**
 * @file light_cube.hpp
 * @brief RB-T03 极轻 Cube：单趟 16×32×32 int8→int32 MMAD（无算法正确性要求）。
 *
 * 作用：NTT 段与 INTT 段各调用一次，证明两段均为有界真计算（非空转加码）。
 ...
 */
#ifndef RB_T03_LIGHT_CUBE_HPP
#define RB_T03_LIGHT_CUBE_HPP
