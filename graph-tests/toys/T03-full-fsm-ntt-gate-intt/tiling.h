#ifndef T03_FULL_FSM_NTT_GATE_INTT_TILING_H
#define T03_FULL_FSM_NTT_GATE_INTT_TILING_H

/**
 * @file tiling.h
 * @brief T03：NTT 1/3 + 生产 GATE 4/8 + INTT 复用 1/3（禁 5/7）的维度与 workspace。
 *
 * 目标（D-EXP-T03）：单 launch 闭环全 FSM；INTT 第二轮仍用 flag 1/3，绝对禁止 5/7（KB X1）。
