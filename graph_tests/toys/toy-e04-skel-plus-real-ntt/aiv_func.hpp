...
public:
    ...
    __aicore__ inline void Init(GM_ADDR dst0, GM_ADDR dst1, GM_ADDR dst2, GM_ADDR dst3, GM_ADDR src) {
        ...
        // pipe.InitBuffer(out_dst2, 1, tileLength * sizeof(int8_t));
        // pipe.InitBuffer(out_dst3, 1, tileLength * sizeof(int8_t));
    }
...
class AivMerge {
    public:
        ...
        __aicore__ inline void Init(GM_ADDR dst, GM_ADDR src0, GM_ADDR src1, GM_ADDR src2, GM_ADDR src3) {
            ...
            // pipe.InitBuffer(in_src2, 1, n * 4 * sizeof(int32_t));
            // pipe.InitBuffer(in_src3, 1, n * 4 * sizeof(int32_t));
