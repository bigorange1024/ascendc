#!/bin/bash
# toy-e04-skel-plus-real-ntt：E03 壳 + L2 真单 poly NTT（ntt256 自包含）+ SET4 ×3
#
# Usage（默认 = 3 轮 SIM；真 NTT + SET4；尽量 golden 对拍）：
...
#
# KERNEL_COMPUTE_BUDGET_SEC 默认 900（3×真 NTT+L1；防挂死，非性能定标）
# 本 NTT golden ≠ F203 Tag5T
CURRENT_DIR=$(
...
echo "[SUCCESS] toy-e04-skel-plus-real-ntt (${RUN_MODE})"
