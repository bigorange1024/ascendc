#!/bin/bash
# toy-e05-skel-shake-plus-ntt：E04 壳 + L1 真 SHAKE256 + L2 真 ntt256 + SET4 ×3
#
# Usage（默认 = 3 轮 SIM；真 SHAKE + 真 NTT + SET4；尽量 golden 对拍）：
...
#
# KERNEL_COMPUTE_BUDGET_SEC 默认 900（3×真 SHAKE+真 NTT；防挂死，非性能定标）
# 本 NTT golden ≠ F203 Tag5T；SHAKE = hashlib.shake_256(abc→32B)
CURRENT_DIR=$(
...
echo "[SUCCESS] toy-e05-skel-shake-plus-ntt (${RUN_MODE})"
