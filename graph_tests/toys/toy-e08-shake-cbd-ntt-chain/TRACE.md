# TRACE.md — toy-e08-shake-cbd-ntt-chain

**形态**：E07 壳 — L1=**真** SHAKE256 + **真** CBD(η=2)；L2=**真**单 poly NTT + **真** basemul + **真** INTT + SET(4)。  
**语义**：CBD=Alg.8 η=2；NTT/INTT ≠ Tag5T（= ntt256 矩阵正/逆）；basemul=Alg.11/12；SHAKE=hashlib.shake_256。
...
**判读**：默认 3× Host `100/101/105/110/111`；每轮 L1 `200→210→211→212→220→221→203` 后 L2 真 NTT + basemul + INTT + `401/402` + `502/512`。
