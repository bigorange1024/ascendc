# TRACE.md — toy-e09-chain-plus-compress

**形态**：E08 壳 — L1=**真** SHAKE256 + **真** CBD(η=2)；L2=**真** NTT + **真** basemul + **真** INTT + **真** Compress_d(d=4) + SET(4)。  
**语义**：Compress=FIPS §4.2.1 d=4；CBD=Alg.8 η=2；NTT/INTT ≠ Tag5T；basemul=Alg.11/12；SHAKE=hashlib.shake_256。
...
| 550 | L2 AIV0 | **真 Compress_d 开始**（非 stub） |
...
**判读**：默认 3× Host `100/101/105/110/111`；每轮 L1 `200→…→221→203` 后 L2 真 NTT+basemul+INTT+Compress + `401/402` + `502/512`。
