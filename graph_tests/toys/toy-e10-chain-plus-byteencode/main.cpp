/**
 * @file main.cpp
 * @brief E10 Host：数字 TRACE + ≥3 轮 2-launch（L1 真 SHAKE+CBD → μ → L2 真 NTT+basemul+INTT+Compress+ByteEncode+SET4）。
 *
 ...
 * 输出 = ByteEncode_d(Compress_d(INTT(MultiplyNTTs(NTT(CBD(prf)),ĝ))))（默认 d=4 → 128B）。
 */
