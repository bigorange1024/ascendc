#!/bin/bash
# toy-e17-l18-fsm-reuse13：单 launch stub CrossCore 序（伪 NTT 1/3 → GATE 4/8 → 伪 INTT 复用 1/3）×8
#
...
# 本线验收：SIM only（勿当门禁跑 CPU）；禁止并行 SIM；未做 E18
CURRENT_DIR=$(
...
echo "[SUCCESS] toy-e17-l18-fsm-reuse13 (${RUN_MODE})"
