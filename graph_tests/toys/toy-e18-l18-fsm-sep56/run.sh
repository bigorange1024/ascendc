#!/bin/bash
# toy-e18-l18-fsm-sep56：单 launch stub CrossCore 序（伪 NTT 1/3 → GATE 4/8 → 伪 INTT 独立 5/6）×8
#
...
# 本线验收：SIM only（勿当门禁跑 CPU）；禁止并行 SIM；相对 E17 仅 INTT 5/6
CURRENT_DIR=$(
...
echo "[SUCCESS] toy-e18-l18-fsm-sep56 (${RUN_MODE})"
