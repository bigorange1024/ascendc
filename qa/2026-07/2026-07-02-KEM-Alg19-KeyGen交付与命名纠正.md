...
关键词：**Alg.19 KeyGen** · **frozen-fix-f203-alg19-kem-keygen-correctness-k4** · **T6 关闭** · **alg16→alg19 重命名** · **vendor PKE** · **顺利原因**
...
| 项 | 结论 |
|----|------|
| **探针** | [`../../ascendc-tests/frozen/frozen-fix-f203-alg19-kem-keygen-correctness-k4/`](../../ascendc-tests/frozen/frozen-fix-f203-alg19-kem-keygen-correctness-k4/) |
...
| 变更 | 说明 |
|------|------|
| `fix-f203-alg16-kem-keygen-k4` → **`frozen-fix-f203-alg19-kem-keygen-correctness-k4`** | 探针目录 |
...
索引：[`STATUS.md`](../../ascendc-tests/frozen/frozen-fix-f203-alg19-kem-keygen-correctness-k4/STATUS.md) · [`INTEGRATION_PLAN.md`](../../ascendc-tests/frozen/frozen-fix-f203-alg19-kem-keygen-correctness-k4/INTEGRATION_PLAN.md) · [`docs/notes/F203-KEM-Alg19-KeyGen设备全链技术总结.md`](../../docs/notes/F203-KEM-Alg19-KeyGen设备全链技术总结.md) · 前日 [`2026-07-01-liboqs验证与KEM-Alg19-KeyGen规划.md`](2026-07-01-liboqs验证与KEM-Alg19-KeyGen规划.md)。
...
### 4.2 建议探针形态（镜像 `frozen-fix-f203-alg19-kem-keygen-correctness-k4`）

| 项 | 建议 |
|----|------|
| **目录** | `../../ascendc-tests/frozen/frozen-fix-f203-alg20-kem-encaps-correctness-k4/` |
...
| 项 | 结论 |
|----|------|
| **目录** | [`../../ascendc-tests/frozen/frozen-fix-f203-alg20-kem-encaps-correctness-k4/`](../../ascendc-tests/frozen/frozen-fix-f203-alg20-kem-encaps-correctness-k4/) |
...
关键词：**Alg.21 Decaps** · **frozen-fix-f203-alg21-kem-decaps-correctness-k4** · **T7c** · **SIM CAModel 污染** · **两段 session workaround**

### 7.1 交付状态

| 项 | 结论 |
|----|------|
| **探针** | [`../../ascendc-tests/frozen/frozen-fix-f203-alg21-kem-decaps-correctness-k4/`](../../ascendc-tests/frozen/frozen-fix-f203-alg21-kem-decaps-correctness-k4/) |
