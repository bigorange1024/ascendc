...
[`fix-f203-alg21-kem-decaps-device-k4/INTEGRATION_PLAN.md`](../../ascendc-tests/fix-f203-alg21-kem-decaps-device-k4/INTEGRATION_PLAN.md) 写死：先 E 后 D；G 融 Encrypt prep；设备 FO；SIM 允许 2-session。
...
已把仓库级 Decaps 默认从 correctness 切到 [`fix-f203-alg21-kem-decaps-device-k4`](../../ascendc-tests/fix-f203-alg21-kem-decaps-device-k4/)：
