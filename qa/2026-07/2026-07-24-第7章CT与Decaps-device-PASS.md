...
已刷新 [`qa/active_sim_regress_summary.md`](../active_sim_regress_summary.md)（**刷新日 2026-07-24**）：

| 目录 | 合法 SIM 合计（D+E） | 拒绝 SIM（约） |
|------|----------------------|----------------|
| `pass-fix-…-decaps-device-ct-k4` | **1050461**（D**286798**+E**763663**） | D≈**286703**+E≈**763747** |
| `exp-…-decaps-ct-k4` | **1050487**（D**286829**+E**763658**） | D≈**286666**+E≈**763697** |
| `stable-…-decaps-ct-k4` | **1050646**（D**286866**+E**763780**） | D≈**286679**+E≈**763735** |

口径：Cloud / Ascend910B4 / `SIM_DIRECT=1` / `decaps_2session`。交付无 `-ct` 行仍沿用 07-20 登记，**未**用 CT 数覆盖。
