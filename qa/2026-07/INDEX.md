...
| 日期 | 文件 | 关键字 |
|------|------|--------|
| 2026-07-15 | [2026-07-15-TODO与T19a-Encaps-device-PASS.md](2026-07-15-TODO与T19a-Encaps-device-PASS.md) | **TODO** · **T19a PASS**（721010）· **Encaps → pass-fix** · scripts Encaps 默认 · **`$写规格$` exp Encaps customspec** · **`docs/research/` 恢复** · **能力DAG方法论 TeX/PDF** · 活跃 SIM tick 表 · T20 关闭 |
