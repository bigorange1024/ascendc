...
| 日期 | 文件 | 关键字 |
|------|------|--------|
| 2026-07-24 | [2026-07-24-第7章CT与Decaps-device-PASS.md](2026-07-24-第7章CT与Decaps-device-PASS.md) | **CT_decaps** · **T19b/c PASS** · `pass-fix-…-decaps-device` · stable 编译期引用 · `decaps_2session` · CPU+SIM `K` max=0 · 拒绝 CPU PASS |
