...
| 日期 | 文件 | 关键字 |
|------|------|--------|
| 2026-07-15 | [2026-07-15-TODO与T19a-Encaps-device-PASS.md](2026-07-15-TODO与T19a-Encaps-device-PASS.md) | **TODO** · **T19a Encaps device PASS**（721010）· **`docs/research/` 恢复** · 活跃 SIM tick 表 · T20 关闭 |
