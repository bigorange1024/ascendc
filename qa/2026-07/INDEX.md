...
| 日期 | 文件 | 关键字 |
|------|------|--------|
| 2026-07-14 | [2026-07-14-KEM-KeyGen-incubating预研重写.md](2026-07-14-KEM-KeyGen-incubating预研重写.md) | **KEM KeyGen【预研】** · **runtime_env** · Cloud 绿 · **`-Werror`/`cp_sync`** · **ntt_onnx PAT 复验六探针绿** · 探针 `run.sh` 批量接入 |
