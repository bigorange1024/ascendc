...
| 日期 | 文件 | 关键字 |
|------|------|--------|
| 2026-07-09 | [2026-07-09-Encrypt默认SIM_DIRECT.md](2026-07-09-Encrypt默认SIM_DIRECT.md) | **默认 `SIM_DIRECT=1`** · **T7b** · **路线 11 关闭** · **Encrypt `#交付#`** · **CPU 辅助 / SIM 主参考** · **目录改名 `*-fips203-mlkem-pke-*`** · **`stable-fips203-mlkem-pke-encrypt-k4`** |
