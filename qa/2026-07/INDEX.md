...
| 日期 | 文件 | 关键字 |
|------|------|--------|
| 2026-07-24 | [2026-07-24-第7章CT与Decaps-device-PASS.md](2026-07-24-第7章CT与Decaps-device-PASS.md) | **CT_decaps** · **`#交付#` Decaps** · **拒绝 SIM** · KAT **10+3** · **roundtrip CPU+SIM** · `M_FILE` · 未跑 NPU · **`-ct` 改名**避 main · 引用审计 · 中文注释 |
