...
关键字：`TODO` · **T20 关闭** · [`active_sim_regress_summary.md`](active_sim_regress_summary.md) · **T19a PASS**（tick **721010**）· **Encaps → `pass-fix-…`** · scripts Encaps 默认 · **`$写规格$` exp Encaps customspec** · **`docs/research/` 恢复** · **已验证能力 DAG 预研方法论 TeX/PDF** · 下一 **T19b/c** 或 Encaps【预研】
