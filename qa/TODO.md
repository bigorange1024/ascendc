...
**最近刷新**：2026-07-27（**T512 W0+W1 全绿，W2 D13/D14/D15 PASS**；只推 research）
...
主线 **ML-KEM 六算子 stable 已齐**（交付 Decaps **无 `-ct`**）；768 incubating+glue 有条件完成（禁 stable-768）。**下一方法论压力床**：**T512**（P0+P1 已落；W0/W1 绿）。打开项：T512 / T768-post / NPU / T23 / SHA3hp / T-WebViz。
...
| **P0** | **T512** | ML-KEM-512：**W0+W1 全绿**（B1–B6）；**W2 D13/D14/D15 PASS**；续 W3/P3；只推 research 不合 main | **D13 tick 230102（ek/dk 800/768B）；D14 tick 338153（c 768B）；D15 tick 168975** |
