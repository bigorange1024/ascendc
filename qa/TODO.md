...
**最近刷新**：2026-07-27（**T512 W0+W1 全绿，W2 D13+D15 PASS**；只推 research）
...
| **P0** | **T512** | ML-KEM-512：**W0+W1 全绿**（B1–B6）；**W2 D13 + D15 PASS**；续 W2/P3；只推 research 不合 main | **D13 tick 230102（ek/dk 800/768B）；D14 待补；D15 tick 168975** |
