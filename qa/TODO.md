...
**最近刷新**：2026-07-27（**T512 计划草案**；768 有条件完成；教材第8章/汇报简报；T-WebViz）
...
主线 **ML-KEM 六算子 stable 已齐**（交付 Decaps **无 `-ct`**）；768 incubating+glue 有条件完成（禁 stable-768）。**下一方法论压力床**：**T512**（计划草案待锁）。打开项：T512 / T768-post / NPU / T23 / SHA3hp / T-WebViz。
...
| **P0** | **T512** | ML-KEM-512（k=2，单 AI Core）：计划+参数卡草案已成；锁决议后自主 P0→P3 incubating + liboqs-512 KAT/RT | **待用户锁 §决议**；见计划/参数卡 |
