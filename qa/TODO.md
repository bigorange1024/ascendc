...
**最近刷新**：2026-07-20（Decaps `#交付#` + **T19i** SIM 3 全链齐；KAT/roundtrip ✓）
...
主线 **ML-KEM 六算子 stable 已齐**（2026-07-20 Decaps `#交付#`）。打开项转为 **NPU / SHA3hp**（T19i 已关）。correctness 仍 vendor **frozen G5/G4**（oracle 对照，不改）。
