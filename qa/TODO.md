...
**最近刷新**：2026-07-27（**T512 W0 B1/B2/B3a/B3b 已绿**；下一刀 W1；用语：缺项/补缺）
...
主线 **ML-KEM 六算子 stable 已齐**（交付 Decaps **无 `-ct`**）；768 incubating+glue 有条件完成（禁 stable-768）。**下一方法论压力床**：**T512**（P0+P1 已落；W0 绿）。打开项：T512 / T768-post / NPU / T23 / SHA3hp / T-WebViz。
...
| **P0** | **T512** | ML-KEM-512（k=2，单 AI Core）：**P0+P1 已落，W0 B1/B2/B3a/B3b 已绿**；自主 W1→P3 + liboqs-512 KAT/RT；用语：缺项/补缺 | **下一刀：W1（SampleNTT / polyvec4 NTT / Multiply/Inner）** |
