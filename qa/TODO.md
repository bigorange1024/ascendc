...
**最近刷新**：2026-07-26（768 **W2 全绿 + W3/D19 KEM KeyGen CPU+SIM 全绿**；T768-W3-D19 关闭）
...
主线 **ML-KEM 六算子 stable 已齐**（交付 Decaps **无 `-ct`**，2026-07-20 `#交付#` + **T19i**）；**`-ct`** 树为 `research/formal-lang-dag` CT 专题（第7章 / 五指标）。768 W3 已完成 **D19**，下一项 **D20 Encaps device-k3**。打开项：**教材细表 / NPU / T23 / SHA3hp**。KEM **correctness 三探针已冻结**（见已关闭表）；**禁止**再当实现参考。
...
| **P1** | **T768-W3-D20+** | ML-KEM-768 W3：D20 Encaps、D21 Decaps、D21ct device-k3 | D19 已绿；D20 下一刀，按参数卡 §3.3 接 D14 k3 Encrypt |
