...
**最近刷新**：2026-07-14（T19f **`#交付#`** → [`stable-fips203-mlkem-kem-keygen-k4`](../examples/stable/stable-fips203-mlkem-kem-keygen-k4/)；下一主线仍 T19a）
...
| **T19f** | incubating KeyGen 重写 → `#交付#` [`stable-…-kem-keygen-k4`](../examples/stable/stable-fips203-mlkem-kem-keygen-k4/) | **完成**（2026-07-14）；exp 副本保留；交付以 stable 为准 |
