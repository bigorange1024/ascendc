...
**最近刷新**：2026-07-27（**T512 W4+glue 有条件完成**；下一刀 liboqs Encaps c；只推 research）
...
| **P0** | **T512** | ML-KEM-512：**W4 incubating 全绿**；AscendC RT 绿；liboqs KeyGen 绿、Encaps c 未齐 | **下一刀：glue Encaps c vs liboqs** |
...
| ID | 事项 | 关闭日 |
|----|------|--------|
| **T512-W4-glue** | ML-KEM-512 W4：E13–E21ct customspec+CPU+SIM 全绿；`exp_kem512_liboqs_roundtrip.sh` AscendC RT CPU+SIM PASS；liboqs-512 KeyGen PASS、Encaps K PASS / c 未对齐；未建 stable-512 | 2026-07-27 |
