...
**最近刷新**：2026-07-26（768 **W0–W3 探针全绿**；用户休息前**一并授权 W4** incubating）
...
| **P0** | **T768-W4** | ML-KEM-768 W4：E13–E15 + E19–E21[+ct] incubating（先 customspec 再写码；registry + 768 roundtrip） | **进行中**（2026-07-26 用户一并授权）；禁 stable-768 |
