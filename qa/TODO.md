...
**最近刷新**：2026-07-08（**Compress/Decompress/ByteEncode/ByteDecode *-d-vec-k4** · d=5/11 · **tail pack 56259 tick** · **内核超时口径**定稿）
...
| 优先级 | ID | 事项 | 状态 |
|--------|-----|------|------|
| **P0** | **T17** | **Alg.14 Encrypt 2 launch 拼接**：prep + compute + **tail pack** GM 直连 | **prep PASS** · **compute SIM 单 launch PASS** · **tail pack PASS**（56259 tick）；待三段 GM 拼接 |
