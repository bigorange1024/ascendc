...
**最近刷新**：2026-07-27（**T512 W0 B3b CBD‑η3 已绿**；下一刀 W0 剩余 B1/B2/B3a；用语：缺项/补缺）
...
| **P0** | **T512** | ML-KEM-512（k=2，单 AI Core）：**P0+P1 已落，W0 B3b CBD‑η3 已绿**；自主 W0→P3 + liboqs-512 KAT/RT；用语：缺项/补缺 | **下一刀：W0 剩余 B1/B2/B3a** |
