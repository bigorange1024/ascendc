...
| **P1** | **T19i** | Decaps SIM 过渡 launch：`fo_only` **内联进** `l18_l19` 尾（SIM **4→3**；CPU 仍可 6） | **pass-fix PASS**（2026-07-20）；**stable/exp 待镜像** |
...
| **T19i** | Decaps `fo_only`→`l18_l19`（SIM 4→3） | **pass-fix PASS**；stable 待镜像（见上表 P1） |
