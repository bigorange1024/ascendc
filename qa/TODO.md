...
**最近刷新**：2026-07-27（**T512 W0/W1 全绿**；下一刀 W2/W3；用语：缺项/补缺）
...
| **P0** | **T512** | ML-KEM-512：P0+P1 已落；**W0 全绿**（B1/B2/B3a/B3b）；**W1 全绿**（B4 SampleNTT 2×2、B5 Stage123 NTT/INTT、B6 Multiply/Inner）；续 W2/W3→P3 + liboqs-512 KAT/RT | **下一刀：W2/W3 device** |
