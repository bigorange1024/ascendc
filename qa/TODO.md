...
**最近刷新**：2026-07-27（**T512 决议已锁**；用语统一缺项/补洞；768 有条件完成）
...
| **P0** | **T512** | ML-KEM-512（k=2，单 AI Core）：决议已锁；自主 P0→P3 incubating + liboqs-512 KAT/RT；用语：缺项/补洞（禁「洞级」等） | **下一刀：P0 目录壳 / sizes**；见计划/参数卡 |
