...
| 项 | 内容 |
|----|------|
| **刷新** | 2026-07-27（新增 **ML-KEM-512 W0 B3b CBD-η3** Cloud SIM tick；ML-KEM-768 全表沿用 07-26；Decaps CT k4 行沿用 07-24） |
...
> Cloud / `SIM_DIRECT=1` / Ascend910B4（2026-07-27）。首个 512 W0 探针；正确性优先，非生产性能基线。
