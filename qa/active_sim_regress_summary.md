...
| [`pass-fix-f203-alg20-kem-encaps-device-k4`](../ascendc-tests/pass-fix-f203-alg20-kem-encaps-device-k4/) | **721010** | T19a pass-fix；`c`/`K` max=0；scripts Encaps 默认 | STATUS 2026-07-15 |
...
| [`exp-fips203-mlkem-kem-encaps-k4`](../examples/incubating/exp-fips203-mlkem-kem-encaps-k4/) | **721211** | 【预研】CPU+SIM PASS（vendored Encrypt + H/G 头；非零 `m` **721033**） | STATUS 2026-07-15 |
