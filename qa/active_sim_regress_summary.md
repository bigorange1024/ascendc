...
| [`stable-fips203-mlkem-kem-decaps-k4`](../examples/stable/stable-fips203-mlkem-kem-decaps-k4/) | **1050620**（D**286851**+E**763769**） | Alg.21；**T19i** SIM **3**；KAT 10+3 / roundtrip ✓；**`scripts/` Decaps 默认** | STATUS 2026-07-20 |
...
| [`pass-fix-f203-alg21-kem-decaps-device-k4`](../ascendc-tests/pass-fix-f203-alg21-kem-decaps-device-k4/) | **1050923**（D**287037**+E**763886**） | Alg.21；**T19i** SIM **3** launch；单库+1session；拒绝绿 | STATUS 2026-07-20 |
