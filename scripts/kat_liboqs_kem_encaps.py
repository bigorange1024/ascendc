...
默认交付目录：examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-kem-encaps-k4
...
ENCAPS_DIR = Path(
    os.environ.get(
        "ENCAPS_DIR",
        REPO_ROOT / "examples/stable/ml-kem/ml-kem-1024/stable-fips203-mlkem-kem-encaps-k4",
    )
)
