...
#
# 默认 ENCAPS_DIR = ascendc-tests/pass-fix-f203-alg20-kem-encaps-device-k4
...
export SOC_VERSION
export ENCAPS_DIR="${ENCAPS_DIR:-${REPO_ROOT}/ascendc-tests/pass-fix-f203-alg20-kem-encaps-device-k4}"
